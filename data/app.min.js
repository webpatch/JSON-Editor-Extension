...
function newFeatureInfo() {
    ...
    return function(e) {
        ...
        var o = i(1),
            r = i(2),
            s = i(3);
        n.modes = {}, n.prototype._create = function(e, t, i) {
            this.container = e, this.options = t || {}, this.json = i || {};
            var n = this.options.mode || "tree";
            this.setMode(n)
        }, n.prototype._delete = function() {}, n.prototype.set = function(e) {
            this.json = e
            ...
            var t, i, o = this.container,
                r = s.extend({}, this.options);
            r.mode = e;
            var a = n.modes[e];
            if (!a) throw new Error('Unknown mode "' + r.mode + '"');
            try {
                var l = "text" == a.data;
                if (i = this.getName(), t = this[l ? "getText" : "get"](), this._delete(), s.clear(this), s.extend(this, a.mixin), this.create(o, r), this.setName(i), this[l ? "setText" : "set"](t), "function" == typeof a.load) try {
                    a.load.call(this)
                } catch (c) {}
            } catch (c) {
                this._onError(c)
            ...
            if ("function" == typeof this.onError && (s.log("WARNING: JSONEditor.onError is deprecated. Use options.error instead."), this.onError(e)), !this.options || "function" != typeof this.options.error) throw e;
            ...
            if (s.isArray(e))
                ...
                var o = e.mode;
                if (o in n.modes) throw new Error('Mode "' + o + '" already registered');
                ...
                for (t = 0; t < r.length; t++)
                    if (i = r[t], i in e.mixin) throw new Error('Reserved property "' + i + '" not allowed in mixin');
                n.modes[o] = e
            }
        }, n.registerMode(o), n.registerMode(r), e.exports = n
    }, function(e, t, i) {
        var n = i(4),
            o = i(5),
            r = i(6),
        ...
        c.create = function(e, t) {
            ...
            this.container = e, this.dom = {}, this.highlighter = new n, this.selection = void 0, this._setOptions(t), this.options.history && "view" !== this.options.mode && (this.history = new o(this)), this._createFrame(), this._createTable()
        }, c._delete = function() {
            this.frame && this.container && this.frame.parentNode == this.container && this.container.removeChild(this.frame)
        }, c._setOptions = function(e) {
            if (this.options = {
                    search: !0,
                    history: !0,
                    mode: "tree",
        ...
        var h = void 0,
            u = null;
        c.set = function(e, t) {
            if (t && (l.log('Warning: second parameter "name" is deprecated. Use setName(name) instead.'), this.options.name = t), e instanceof Function || void 0 === e) this.clear();
            else {
            ...
            return h && h.blur(), this.node ? this.node.getValue() : void 0
        }, c.getText = function() {
            return JSON.stringify(this.get())
        }, c.setText = function(e) {
            this.set(l.parse(e))
        }, c.setName = function(e) {
        ...
        }, c._onAction = function(e, t) {
            if (this.history && this.history.add(e, t), this.options.change) try {
                this.options.change()
            } catch (i) {
                l.log("Error in change callback: ", i)
            }
        }, c.startAutoScroll = function(e) {
            var t = this,
                i = this.content,
                n = l.getAbsoluteTop(i),
                o = i.clientHeight,
                r = n + o,
                s = 24,
                a = 50;
            this.autoScrollStep = n + s > e && i.scrollTop > 0 ? (n + s - e) / 3 : e > r - s && o + i.scrollTop < i.scrollHeight ? (r - s - e) / 3 : void 0, this.autoScrollStep ? this.autoScrollTimer || (this.autoScrollTimer = setInterval(function() {
            ...
            e && ("scrollTop" in e && this.content && (this.content.scrollTop = e.scrollTop), e.range && l.setSelectionOffset(e.range), e.dom && e.dom.focus())
        }, c.getSelection = function() {
            return {
                dom: u,
                scrollTop: this.content ? this.content.scrollTop : 0,
                range: l.getSelectionOffset()
            }
        }, c.scrollTo = function(e, t) {
            var i = this.content;
            if (i) {
                var n = this;
                ...
                var o = i.clientHeight,
                    ...
                    a = function() {
                        var e = i.scrollTop,
                            o = s - e;
                        Math.abs(o) > 3 ? (i.scrollTop += o / 3, n.animateCallback = t, n.animateTimeout = setTimeout(a, 50)) : (t && t(!0), i.scrollTop = s, delete n.animateTimeout, delete n.animateCallback)
                    };
                a()
            } else t && t(!1)
        }, c._createFrame = function() {
            function e(e) {
                t._onEvent(e)
            }
            ...
            }, this.frame.oninput = e, this.frame.onchange = e, this.frame.onkeydown = e, this.frame.onkeyup = e, this.frame.oncut = e, this.frame.onpaste = e, this.frame.onmousedown = e, this.frame.onmouseup = e, this.frame.onmouseover = e, this.frame.onmouseout = e, l.addEventListener(this.frame, "focus", e, !0), l.addEventListener(this.frame, "blur", e, !0), this.frame.onfocusin = e, this.frame.onfocusout = e, this.menu = document.createElement("div"), this.menu.className = "menu", this.frame.appendChild(this.menu);
            var i = document.createElement("button");
            i.className = "expand-all", i.title = "Expand all fields", i.onclick = function() {
                t.expandAll()
            }, this.menu.appendChild(i);
            var n = document.createElement("button");
            if (n.title = "Collapse all fields", n.className = "collapse-all", n.onclick = function() {
                    t.collapseAll()
                }, this.menu.appendChild(n), this.history) {
                var o = document.createElement("button");
                o.className = "undo separator", o.title = "Undo last action (Ctrl+Z)", o.onclick = function() {
                    t._onUndo()
            ...
            if (this.options && this.options.modes && this.options.modes.length) {
                var c = a.create(this, this.options.modes, this.options.mode);
        ...
        }, c._onEvent = function(e) {
            var t = e.target;
            "keydown" == e.type && this._onKeyDown(e), "focus" == e.type && (u = t);
            var i = s.getNodeFromTarget(t);
            i && i.onEvent(e)
        }, c._onKeyDown = function(e) {
            var t = e.which || e.keyCode,
                i = e.ctrlKey,
                n = e.shiftKey,
                o = !1;
            if (9 == t && setTimeout(function() {
                    l.selectContentEditable(u)
                }, 0), this.searchBox)
                if (i && 70 == t) this.searchBox.dom.search.focus(), this.searchBox.dom.search.select(), o = !0;
        ...
        var n;
        try {
            n = i(10), i(11), i(12), i(9)
        } catch (o) {}
        var r = i(8),
            s = i(3),
            a = {};
        a.create = function(e, t) {
            t = t || {}, this.options = t, this.indentation = t.indentation ? Number(t.indentation) : 2, this.mode = "code" == t.mode ? "code" : "text", "code" == this.mode && "undefined" == typeof n && (this.mode = "text", s.log("WARNING: Cannot load code editor, Ace library not loaded. Falling back to plain text editor"));
            var i = this;
            ...
            var o = document.createElement("button");
            o.className = "format", o.title = "Format JSON data, with proper indentation and line feeds (Ctrl+\\)", this.menu.appendChild(o), o.onclick = function() {
                try {
                    i.format()
                } catch (e) {
                    i._onError(e)
            ...
            if (a.className = "compact", a.title = "Compact JSON data, remove all whitespaces (Ctrl+Shift+\\)", this.menu.appendChild(a), a.onclick = function() {
                    try {
                        i.compact()
                    } catch (e) {
                        i._onError(e)
                ...
                var l = r.create(this, this.options.modes, this.options.mode);
                this.menu.appendChild(l), this.dom.modeBox = l
            }
            if (this.content = document.createElement("div"), this.content.className = "outer", this.frame.appendChild(this.content), this.container.appendChild(this.frame), "code" == this.mode) {
                ...
                c.setTheme("ace/theme/jsoneditor"), c.setShowPrintMargin(!1), c.setFontSize(13), c.getSession().setMode("ace/mode/json"), c.getSession().setTabSize(this.indentation), c.getSession().setUseSoftTabs(!0), c.getSession().setUseWrapMode(!0), this.editor = c;
                var h = document.createElement("a");
                h.appendChild(document.createTextNode("Copy")), h.href = "#", h.target = "_blank", h.className = "poweredBy", this.menu.appendChild(h), t.change && c.on("change", function() {
                    t.change()
                })
            } else {
                var u = document.createElement("textarea");
                u.className = "text", u.spellcheck = !1, this.content.appendChild(u), this.textarea = u, t.change && (null === this.textarea.oninput ? this.textarea.oninput = function() {
                    t.change()
            ...
            var t = e.which || e.keyCode,
                i = !1;
            220 == t && e.ctrlKey && (e.shiftKey ? this.compact() : this.format(), i = !0), i && (e.preventDefault(), e.stopPropagation())
        }, a._delete = function() {
            this.frame && this.container && this.frame.parentNode == this.container && this.container.removeChild(this.frame)
            ...
            try {
                ...
                t = s.sanitize(t), this.setText(t), e = s.parse(t)
            }
            return e
        }, a.getText = function() {
        ...
        t.parse = function(e) {
            ...
            function r() {
                for (c += 2; c < e.length && ("*" !== t() || "/" !== i());) c++;
                c += 2
            }

            function s(i) {
                l.push('"'), c++;
                for (var o = t(); c < e.length && o !== i;) '"' === o && "\\" !== n() && l.push("\\"), "\\" === o && (c++, o = t(), "'" !== o && l.push("\\")), l.push(o), c++, o = t();
                o === i && (l.push('"'), c++)
            }

            function a() {
                for (var e = ["null", "true", "false"], i = "", n = t(), o = /[a-zA-Z_$\d]/; o.test(n);) i += n, c++, n = t();
                l.push(-1 === e.indexOf(i) ? '"' + i + '"' : i)
            }
            var l = [],
                c = 0,
            ...
            for (h && (e = h[3]); c < e.length;) {
                var u = t();
                "/" === u && "*" === i() ? r() : "'" === u || '"' === u ? s(u) : /[a-zA-Z_$]/.test(u) && o() ? a() : (l.push(u), c++)
            }
            return l.join("")
        ...
        t.isUrl = function(e) {
            ...
            if (document.createRange && window.getSelection) {
                ...
                if (i) {
                    ...
                    n.setStart(e.container.firstChild, e.startOffset), n.setEnd(e.container.firstChild, e.endOffset), t.setSelection(n)
                }
            }
        ...
        t.addEventListener = function(e, i, n, o) {
            if (e.addEventListener) return void 0 === o && (o = !1), "mousewheel" === i && t.isFirefox() && (i = "DOMMouseScroll"), e.addEventListener(i, n, o), n;
            if (e.attachEvent) {
                var r = function() {
                    return n.call(e, window.event)
                };
                return e.attachEvent("on" + i, r), r
            }
        }, t.removeEventListener = function(e, i, n, o) {
            e.removeEventListener ? (void 0 === o && (o = !1), "mousewheel" === i && t.isFirefox() && (i = "DOMMouseScroll"), e.removeEventListener(i, n, o)) : e.detachEvent && e.detachEvent("on" + i, n)
        }
    }, function(e) {
        function t() {
            this.locked = !1
        ...
        }, t.prototype._cancelUnhighlight = function() {
        ...
        n.prototype.onChange = function() {}, n.prototype.add = function(e, t) {
            ...
            if (this.canUndo()) {
                ...
                if (e) {
                    ...
                    t && t.undo ? (t.undo(e.params), e.params.oldSelection && this.editor.setSelection(e.params.oldSelection)) : o.log('Error: unknown action "' + e.action + '"')
                }
            ...
            if (this.canRedo()) {
                ...
                if (e) {
                    var t = this.actions[e.action];
                    t && t.redo ? (t.redo(e.params), e.params.newSelection && this.editor.setSelection(e.params.newSelection)) : o.log('Error: unknown action "' + e.action + '"')
                }
                this.onChange()
            }
        }, e.exports = n
        ...
        function t(e, t) {
            ...
            this.dom.results = a, a.className = "results", s.appendChild(a), s = document.createElement("td"), r.appendChild(s);
            var l = document.createElement("div");
            this.dom.input = l, l.className = "frame", l.title = "Search fields and values", s.appendChild(l);
            var c = document.createElement("table");
            l.appendChild(c);
            var h = document.createElement("tbody");
            c.appendChild(h), r = document.createElement("tr"), h.appendChild(r);
            var u = document.createElement("button");
            u.className = "refresh", s = document.createElement("td"), s.appendChild(u), r.appendChild(s);
            var d = document.createElement("input");
            this.dom.search = d, d.oninput = function(e) {
                ...
                d.select()
            }, s = document.createElement("td"), s.appendChild(d), r.appendChild(s);
            var g = document.createElement("button");
            g.title = "Next result (Enter)", g.className = "next", g.onclick = function() {
                i.next()
            }, s = document.createElement("td"), s.appendChild(g), r.appendChild(s);
        ...
        }, t.prototype._setActiveResult = function(e, t) {
        ...
        }, t.prototype._clearDelay = function() {
            void 0 != this.timeout && (clearTimeout(this.timeout), delete this.timeout)
        }, t.prototype._onDelayedSearch = function() {
            this._clearDelay();
            var e = this;
            this.timeout = setTimeout(function(t) {
                e._onSearch(t)
            }, this.delay)
        }, t.prototype._onSearch = function(e, t) {
            this._clearDelay();
            var i = this.dom.search.value,
                n = i.length > 0 ? i : void 0;
        ...
        n.prototype._updateEditability = function() {
            if (this.editable = {
                ...
                var e = this.editor.options.editable({
                    field: this.field,
                    value: this.value,
                    path: this.path()
                });
            ...
            this.field = e, this.fieldEditable = t === !0
            ...
            if ("array" == this.type) {
                this.childs = [];
                for (var s = 0, a = e.length; a > s; s++) i = e[s], void 0 === i || i instanceof Function || (o = new n(this.editor, {
                    value: i
                }), this.appendChild(o));
                this.value = ""
            } else if ("object" == this.type) {
                this.childs = [];
                for (var l in e) e.hasOwnProperty(l) && (i = e[l], void 0 === i || i instanceof Function || (o = new n(this.editor, {
                    field: l,
                    value: i
                }), this.appendChild(o)));
                this.value = ""
            ...
            this.childs && (this.expanded = !0, this.dom.expand && (this.dom.expand.className = "expanded"), this.showChilds(), e !== !1 && this.childs.forEach(function(t) {
                t.expand(e)
            }))
            ...
            if (this._hasChilds()) {
                ...
                if (this.expanded) {
                    ...
                    o && r && r.insertBefore(n, o), e.showChilds()
                }
                this.updateDom({
                    updateIndexes: !0
                }), e.updateDom({
            ...
            if (this._hasChilds()) {
                ...
                if (void 0 != this.value) {
                    ...
                    t = a.indexOf(n), -1 != t && (this.searchValue = !0, i.push({
                        node: this,
                        elem: "value"
                    }))
                }
            ...
            if (!this.dom.tr || !this.dom.tr.parentNode)
                for (var t = this.parent, i = !1; t;) t.expand(i), t = t.parent;
            ...
            if (t)
                for (var i = 0, n = t.length; n > i; i++)
                    if (t[i].containsNode(e)) return !0;
            return !1
            ...
            if (t != e) {
                ...
                ("auto" == e || "string" == e) && (this.value = "string" == e ? String(this.value) : this._stringCast(String(this.value)), this.focus()), this.updateDom({
                    updateIndexes: !0
                })
            }
            ...
            if (this.dom.value && "array" != this.type && "object" != this.type && (this.valueInnerText = s.getInnerText(this.dom.value)), void 0 != this.valueInnerText) try {
                ...
                if (this.value = void 0, e !== !0) throw o
            }
        }, n.prototype._updateDomValue = function() {
            var e = this.dom.value;
            if (e) {
                var t = this.value,
                    i = "auto" == this.type ? s.type(t) : this.type,
                    n = "string" == i && s.isUrl(t),
                    o = "";
                o = n && !this.editable.value ? "" : "string" == i ? "green" : "number" == i ? "red" : "boolean" == i ? "darkorange" : this._hasChilds() ? "" : null === t ? "#004ED0" : "black", e.style.color = o;
                var r = "" == String(this.value) && "array" != this.type && "object" != this.type;
                if (r ? s.addClassName(e, "empty") : s.removeClassName(e, "empty"), n ? s.addClassName(e, "url") : s.removeClassName(e, "url"), "array" == i || "object" == i) {
                    var a = this.childs ? this.childs.length : 0;
                    e.title = this.type + " containing " + a + " items"
                } else "string" == i && s.isUrl(t) ? this.editable.value && (e.title = "Ctrl+Click or Ctrl+Enter to open url in new window") : e.title = "";
                this.searchValueActive ? s.addClassName(e, "highlight-active") : s.removeClassName(e, "highlight-active"), this.searchValue ? s.addClassName(e, "highlight") : s.removeClassName(e, "highlight"), s.stripFormatting(e)
            }
        }, n.prototype._updateDomField = function() {
            var e = this.dom.field;
            if (e) {
                var t = "" == String(this.field) && "array" != this.parent.type;
                t ? s.addClassName(e, "empty") : s.removeClassName(e, "empty"), this.searchFieldActive ? s.addClassName(e, "highlight-active") : s.removeClassName(e, "highlight-active"), this.searchField ? s.addClassName(e, "highlight") : s.removeClassName(e, "highlight"), s.stripFormatting(e)
            }
            ...
            var t = this;
            this.mousemove || (this.mousemove = s.addEventListener(document, "mousemove", function(e) {
                t._onDrag(e)
            })), this.mouseup || (this.mouseup = s.addEventListener(document, "mouseup", function(e) {
                t._onDragEnd(e)
            ...
            var t, i, o, r, l, c, h, u, d, g, f, p, m, v, w = e.pageY,
                A = e.pageX,
                C = !1;
            if (t = this.dom.tr, d = s.getAbsoluteTop(t), p = t.offsetHeight, d > w) {
                i = t;
                do i = i.previousSibling, h = n.getNodeFromTarget(i), g = i ? s.getAbsoluteTop(i) : 0; while (i && g > w);
                h && !h.parent && (h = void 0), h || (c = t.parentNode.firstChild, i = c ? c.nextSibling : void 0, h = n.getNodeFromTarget(i), h == this && (h = void 0)), h && (i = h.dom.tr, g = i ? s.getAbsoluteTop(i) : 0, w > g + p && (h = void 0)), h && (h.parent.moveBefore(this, h), C = !0)
            } else if (l = this.expanded && this.append ? this.append.getDom() : this.dom.tr, r = l ? l.nextSibling : void 0) {
                f = s.getAbsoluteTop(r), o = r;
                do u = n.getNodeFromTarget(o), o && (m = o.nextSibling ? s.getAbsoluteTop(o.nextSibling) : 0, v = o ? m - f : 0, 1 == u.parent.childs.length && u.parent.childs[0] == this && (d += 23)), o = o.nextSibling; while (o && w > d + v);
                if (u && u.parent) {
                    var E = A - this.drag.mouseX,
                        y = Math.round(E / 24 / 2),
                        F = this.drag.level + y,
                        b = u.getLevel();
                    for (i = u.dom.tr.previousSibling; F > b && i;) {
                        if (h = n.getNodeFromTarget(i), h == this || h._isChildOf(this));
                        else {
                            if (!(h instanceof a)) break;
                            var x = h.parent.childs;
                            if (!(x.length > 1 || 1 == x.length && x[0] != this)) break;
                            u = n.getNodeFromTarget(i), b = u.getLevel()
                        }
                        i = i.previousSibling
                    }
                    l.nextSibling != u.dom.tr && (u.parent.moveBefore(this, u), C = !0)
                }
            }
            C && (this.drag.mouseX = A, this.drag.level = this.getLevel()), this.editor.startAutoScroll(w), e.preventDefault()
            ...
            (t.startParent != t.endParent || t.startIndex != t.endIndex) && this.editor._onAction("moveNode", t), document.body.style.cursor = this.drag.oldCursor, this.editor.highlighter.unlock(), delete this.drag, this.mousemove && (s.removeEventListener(document, "mousemove", this.mousemove), delete this.mousemove), this.mouseup && (s.removeEventListener(document, "mouseup", this.mouseup), delete this.mouseup), this.editor.stopAutoScroll(), e.preventDefault()
            ...
            if (o) {
                ...
                o.innerHTML = "array" == this.type ? "[" + r + "]" : "object" == this.type ? "{" + r + "}" : this._escapeHTML(this.value)
            }
            ...
            var r = document.createElement("td");
            r.className = "tree", n.appendChild(r), e.field = this._createDomField(), r.appendChild(e.field), e.tdField = r;
            var s = document.createElement("td");
            s.className = "tree", n.appendChild(s), "object" != this.type && "array" != this.type && (s.appendChild(document.createTextNode(":")), s.className = "separator"), e.tdSeparator = s;
            ...
            var t, i = e.type,
                ...
                r = this,
                a = this._hasChilds();
            if ((n == o.drag || n == o.menu) && ("mouseover" == i ? this.editor.highlighter.highlight(this) : "mouseout" == i && this.editor.highlighter.unhighlight()), "mousedown" == i && n == o.drag && this._onDragStart(e), "click" == i && n == o.menu) {
                var l = r.editor.highlighter;
                l.highlight(r), l.lock(), s.addClassName(o.menu, "selected"), this.showContextMenu(o.menu, function() {
                    s.removeClassName(o.menu, "selected"), l.unlock(), l.unhighlight()
                })
            }
            if ("click" == i && n == o.expand && a) {
                var c = e.ctrlKey;
                this._onExpand(c)
            }
            var h = o.value;
            ...
            if (n == u) switch (i) {
                ...
                case "blur":
                case "change":
                    this._getDomField(!0), this._updateDomField(), this.field && (u.innerHTML = this._escapeHTML(this.field));
                    break;
                case "input":
            ...
            var d = o.tree;
            if (n == d.parentNode) switch (i) {
                case "click":
                    var g = void 0 != e.offsetX ? e.offsetX < 24 * (this.getLevel() + 1) : e.pageX < s.getAbsoluteLeft(o.tdSeparator);
                    g || a ? u && (s.setEndOfContentEditable(u), u.focus()) : h && (s.setEndOfContentEditable(h), h.focus())
            }
            if (n == o.tdExpand && !a || n == o.tdField || n == o.tdSeparator) switch (i) {
                case "click":
                    u && (s.setEndOfContentEditable(u), u.focus())
            }
            "keydown" == i && this.onKeyDown(e)
        }, n.prototype.onKeyDown = function(e) {
            var t, i, o, r, l = e.which || e.keyCode,
                c = e.target || e.srcElement,
                h = e.ctrlKey,
                u = e.shiftKey,
                d = e.altKey,
                g = !1,
                f = "tree" === this.editor.options.mode;
            if (13 == l) {
                if (c == this.dom.value)(!this.editable.value || e.ctrlKey) && s.isUrl(this.value) && (window.open(this.value, "_blank"), g = !0);
                else if (c == this.dom.expand) {
                    var p = this._hasChilds();
                    if (p) {
                        var m = e.ctrlKey;
                        this._onExpand(m), c.focus(), g = !0
                    }
                }
            } else if (68 == l) h && f && (this._onDuplicate(), g = !0);
            else if (69 == l) h && (this._onExpand(u), c.focus(), g = !0);
            else if (77 == l && f) h && (this.showContextMenu(c), g = !0);
            else if (46 == l && f) h && (this._onRemove(), g = !0);
            else if (45 == l && f) h && !u ? (this._onInsertBefore(), g = !0) : h && u && (this._onInsertAfter(), g = !0);
            else if (35 == l) {
                if (d) {
                    var v = this._lastNode();
                    v && v.focus(n.focusElement || this._getElementName(c)), g = !0
                }
            } else if (36 == l) {
                if (d) {
                    var w = this._firstNode();
                    w && w.focus(n.focusElement || this._getElementName(c)), g = !0
                }
            } else if (37 == l) {
                if (d && !u) {
                    var A = this._previousElement(c);
                    A && this.focus(this._getElementName(A)), g = !0
                } else if (d && u && f) {
                    if (this.expanded) {
                        var C = this.getAppend();
                        o = C ? C.nextSibling : void 0
                    } else {
                        var E = this.getDom();
                        o = E.nextSibling
                    }
                    o && (i = n.getNodeFromTarget(o), r = o.nextSibling, b = n.getNodeFromTarget(r), i && i instanceof a && 1 != this.parent.childs.length && b && b.parent && (b.parent.moveBefore(this, b), this.focus(n.focusElement || this._getElementName(c))))
                }
            } else if (38 == l) d && !u ? (t = this._previousNode(), t && t.focus(n.focusElement || this._getElementName(c)), g = !0) : d && u && (t = this._previousNode(), t && t.parent && (t.parent.moveBefore(this, t), this.focus(n.focusElement || this._getElementName(c))), g = !0);
            else if (39 == l) {
                if (d && !u) {
                    var y = this._nextElement(c);
                    y && this.focus(this._getElementName(y)), g = !0
                } else if (d && u) {
                    E = this.getDom();
                    var F = E.previousSibling;
                    F && (t = n.getNodeFromTarget(F), t && t.parent && t instanceof a && !t.isVisible() && (t.parent.moveBefore(this, t), this.focus(n.focusElement || this._getElementName(c))))
                }
            } else if (40 == l)
                if (d && !u) i = this._nextNode(), i && i.focus(n.focusElement || this._getElementName(c)), g = !0;
                else if (d && u && f) {
                i = this.expanded ? this.append ? this.append._nextNode() : void 0 : this._nextNode(), o = i ? i.getDom() : void 0, r = 1 == this.parent.childs.length ? o : o ? o.nextSibling : void 0;
                var b = n.getNodeFromTarget(r);
                b && b.parent && (b.parent.moveBefore(this, b), this.focus(n.focusElement || this._getElementName(c))), g = !0
            }
            ...
            var t = this.dom;
            for (var i in t)
                if (t.hasOwnProperty(i) && t[i] == e) return i;
            return null
        ...
        function n(e, t, i) {
            ...
            for (var r = {
                ...
                c.className = "type-modes" + (i == l ? " selected" : ""), s.push(c)
            }
            var h = r[i];
            if (!h) throw new Error('Unknown mode "' + i + '"');
            var u = h.text,
                d = document.createElement("button");
            return d.className = "modes separator", d.innerHTML = u + " &#x25BE;", d.title = "Switch editor mode", d.onclick = function() {
                var e = new o(s);
                e.show(d)
            }, d
        }
        ...
        ! function() {
            ...
            if (t || "undefined" == typeof acequirejs) {
                ...
                var n, o, r, s, a, l = Function.prototype.call,
                    c = Array.prototype,
                    h = Object.prototype,
                    u = c.slice,
                    d = l.bind(h.toString),
                    g = l.bind(h.hasOwnProperty);
                if ((a = g(h, "__defineGetter__")) && (n = l.bind(h.__defineGetter__), o = l.bind(h.__defineSetter__), r = l.bind(h.__lookupGetter__), s = l.bind(h.__lookupSetter__)), 2 != [1, 2].splice(0).length)
                    if (function() {
                            function e(e) {
                                var t = new Array(e + 2);
                                return t[0] = t[1] = 0, t
                        ...
                        var n = this.slice(e, e + t),
                            ...
                            r = o.length;
                        if (e === i) r && this.push.apply(this, o);
                        else {
                            ...
                            if (r && e === h) this.length = h, this.push.apply(this, o);
                                ...
                                for (this.length = h + r, d = 0; r > d; ++d) this[e + d] = o[d]
                        }
                        return n
                    };
                ...
                if (Array.prototype.forEach || (Array.prototype.forEach = function(e) {
                        var t = R(this),
                            i = m && "[object String]" == d(this) ? this.split("") : t,
                            n = arguments[1],
                            o = -1,
                            r = i.length >>> 0;
                        ...
                        var t, i = R(this),
                            n = m && "[object String]" == d(this) ? this.split("") : i,
                            o = n.length >>> 0,
                            r = [],
                            s = arguments[1];
                        if ("[object Function]" != d(e)) throw new TypeError(e + " is not a function");
                        ...
                        if ("[object Function]" != d(e)) throw new TypeError(e + " is not a function");
                        for (var r = 0; n > r; r++)
                            if (r in i && !e.call(o, i[r], r, t)) return !1;
                        return !0
                        ...
                        if ("[object Function]" != d(e)) throw new TypeError(e + " is not a function");
                        for (var r = 0; n > r; r++)
                            if (r in i && e.call(o, i[r], r, t)) return !0;
                        return !1
                        ...
                        var t = m && "[object String]" == d(this) ? this.split("") : R(this),
                            n = t.length >>> 0;
                        if (!n) return -1;
                        var o = 0;
                    ...
                    Object.getOwnPropertyDescriptor = function(e, t) {
                        ...
                        if (g(e, t)) {
                            ...
                            if (i = {
                                ...
                                var n = r(e, t),
                                    o = s(e, t);
                                if (e.__proto__ = l, n || o) return n && (i.get = n), o && (i.set = o), i
                            }
                ...
                if (Object.defineProperty) {
                    ...
                    if (!A || !C) var E = Object.defineProperty
                }
                if (!Object.defineProperty || E) {
                    var y = "Property description must be an object: ",
                        F = "Object.defineProperty called on non-object: ",
                    ...
                    Object.defineProperty = function(e, t, i) {
                        ...
                        if (g(i, "value"))
                            ...
                            g(i, "get") && n(e, t, i.get), g(i, "set") && o(e, t, i.set)
                        }
                        return e
                    }
                }
                ...
                if (!String.prototype.trim || k.trim()) {
                    k = "[" + k + "]";
                    var _ = new RegExp("^" + k + k + "*"),
                        L = new RegExp(k + k + "*$");
                    String.prototype.trim = function() {
                        return String(this).replace(_, "").replace(L, "")
                    }
                }
                var R = function(e) {
                ...
                if ("undefined" != typeof document) {
                    ...
                    t.getDocumentHead = function(e) {
                        ...
                        if (o = o || document, n && t.hasCssString(n, o)) return null;
                        var r;
                ...
                function i(e, t, i) {
                    ...
                    if (!o.isMac && s) {
                        ...
                        if (18 === i || 17 === i) {
                            ...
                            if (17 === i && 1 === c) a = t.timeStamp;
                            else if (18 === i && 3 === l && 2 === c) {
                                var h = -a;
                                a = t.timeStamp, h += a, 3 > h && (s.altGr = !0)
                            }
                        }
                    }
                    ...
                    return l || i in n.FUNCTION_KEYS || i in n.PRINTABLE_KEYS ? e(t, l, i) : !1
                }
                var n = e("./keys"),
                    o = e("./useragent");
                    ...
                    t.addListener(e, "mousedown", function(e) {
                        if (0 !== t.getButton(e) ? c = 0 : e.detail > 1 ? (c++, c > 4 && (c = 1)) : c = 1, o.isIE) {
                            ...
                            (!l || u) && (c = 1), l && clearTimeout(l), l = setTimeout(function() {
                                l = null
                            }, i[c - 1] || 600), 1 == c && (s = e.clientX, a = e.clientY)
                        }
                        if (e._clicks = c, n[r]("mousedown", e), c > 4) c = 0;
                        else if (c > 1) return n[r](h[c], e)
                ...
                t.stringTrimLeft = function(e) {
                    ...
                    var n = i();
                    for (var o in e) n[o] = "object" == typeof e[o] ? t.deepCopy(e[o]) : e[o];
                    return n
                ...
                var i = e("../lib/event"),
                    ...
                    l = function(e, t) {
                        function l(e) {
                            if (!p) {
                                if (B) t = 0, i = e ? 0 : u.value.length - 1;
                                else var t = e ? 2 : 1,
                                    i = 2;
                                try {
                        ...
                        function c() {
                            p || (u.value = d, n.isWebKit && E.schedule())
                        }
                        ...
                        u.className = "ace_text-input", n.isTouchPad && u.setAttribute("x-palm-disable-auto-cap", !0), u.wrap = "off", u.autocorrect = "off", u.autocapitalize = "off", u.spellcheck = !1, u.style.opacity = "0", n.isOldIE && (u.style.top = "-100px"), e.insertBefore(u, e.firstChild);
                        var d = "",
                            g = !1,
                            f = !1,
                            p = !1,
                            ...
                            v = !0;
                        try {
                            var w = document.activeElement === u
                        } catch (A) {}
                            ...
                            var F = !1,
                                b = function(e) {
                                    if (!F) {
                                        var t = u.value;
                                        if (!p && t && t != d) {
                                            if (e && t == d[0]) return x.schedule();
                                            k(t), F = !0, c(), F = !1
                                        }
                                    }
                                },
                                x = r.delayedCall(b);
                            i.addListener(u, "propertychange", b);
                            var S = {
                                13: 1,
                                27: 1
                            };
                            i.addListener(u, "keyup", function(e) {
                                return !p || u.value && !S[e.keyCode] || setTimeout(P, 0), (u.value.charCodeAt(0) || 0) < 129 ? x.call() : void(p ? I() : N())
                            }), i.addListener(u, "keydown", function() {
                                x.schedule(50)
                            })
                        }
                        var D = function() {
                                g ? g = !1 : y(u) ? (t.selectAll(), l()) : B && l(t.selection.isEmpty())
                            },
                            B = null;
                        ...
                        var $ = !1,
                            k = function(e) {
                                B && (e = B(e), B = null), f ? (l(), e && t.onPaste(e), f = !1) : e == d.charAt(0) ? $ ? t.execCommand("del", {
                                    source: "ace"
                                }) : t.execCommand("backspace", {
                                    source: "ace"
                                }) : (e.substring(0, 2) == d ? e = e.substr(2) : e.charAt(0) == d.charAt(0) ? e = e.substr(1) : e.charAt(e.length - 1) == d.charAt(0) && (e = e.slice(0, -1)), e.charAt(e.length - 1) == d.charAt(0) && (e = e.slice(0, -1)), e && t.onTextInput(e)), $ && ($ = !1)
                            },
                            _ = function() {
                                if (!p) {
                                    var e = u.value;
                            ...
                            R = function(e, n) {
                                var o = t.getCopyText();
                                return o ? void(L(e, o) ? (n ? t.onCut() : t.onCopy(), i.preventDefault(e)) : (g = !0, u.value = o, u.select(), setTimeout(function() {
                                    g = !1, c(), l(), n ? t.onCut() : t.onCopy()
                                }))) : i.preventDefault(e)
                            },
                            T = function(e) {
                                R(e, !0)
                            ...
                            O = function(e) {
                                var o = L(e);
                                "string" == typeof o ? (o && t.onPaste(o), n.isIE && setTimeout(l), i.preventDefault(e)) : (u.value = "", f = !0)
                            };
                        i.addCommandKeyListener(u, t.onCommandKey.bind(t)), i.addListener(u, "select", D), i.addListener(u, "input", _), i.addListener(u, "cut", T), i.addListener(u, "copy", M), i.addListener(u, "paste", O), "oncut" in u && "oncopy" in u && "onpaste" in u || i.addListener(e, "keydown", function(e) {
                        ...
                        var N = function() {
                                p || !t.onCompositionStart || t.$readOnly || (p = {}, t.onCompositionStart(), setTimeout(I, 0), t.on("mousedown", P), t.selection.isEmpty() || (t.insert(""), t.session.markUndoGroup(), t.selection.clearSelection()), t.session.markUndoGroup())
                            },
                            I = function() {
                                if (p && t.onCompositionUpdate && !t.$readOnly) {
                                    ...
                                    if (p.lastValue !== e && (t.onCompositionUpdate(e), p.lastValue && t.undo(), p.lastValue = e, p.lastValue)) {
                                        ...
                                        t.insert(p.lastValue), t.session.markUndoGroup(), p.range = t.selection.getRange(), t.selection.setRange(i), t.selection.clearSelection()
                                    }
                                }
                            },
                            P = function(e) {
                                if (t.onCompositionEnd && !t.$readOnly) {
                                    ...
                                    var n = setTimeout(function() {
                                        n = null;
                                        var e = u.value.replace(/\x01/g, "");
                                        p || (e == i.lastValue ? c() : !i.lastValue && e && (c(), k(e)))
                                    });
                                    B = function(e) {
                            ...
                            j = r.delayedCall(I, 50);
                        i.addListener(u, "compositionstart", N), n.isGecko ? i.addListener(u, "text", function() {
                            j.schedule()
                            ...
                            $ = !0, l(t.selection.isEmpty()), t._emit("nativecontextmenu", {
                                target: t,
                                domEvent: e
                            }), this.moveToMouse(e, !0)
                        }, this.moveToMouse = function(e, r) {
                            if (r || !n.isOldIE) {
                                m || (m = u.style.cssText), u.style.cssText = (r ? "z-index:100000;" : "") + "height:" + u.style.height + ";" + (n.isIE ? "opacity:0.1;" : "");
                                var s = t.container.getBoundingClientRect(),
                                    ...
                                    d = s.bottom - l - u.clientHeight - 2,
                                    g = function(e) {
                                        u.style.left = e.clientX - c - 2 + "px", u.style.top = Math.min(e.clientY - l - 2, d) + "px"
                                    };
                                g(e), "mousedown" == e.type && (t.renderer.$keepTextAreaAtCursor && (t.renderer.$keepTextAreaAtCursor = null), n.isWin && !n.isOldIE && i.capture(t.container, g, h))
                            }
                        }, this.onContextMenuClose = h;
                        var W, H = function(e) {
                            t.textInput.onContextMenu(e), h()
                        };
                        i.addListener(t.renderer.scroller, "contextmenu", H), i.addListener(u, "contextmenu", H)
                    };
                t.TextInput = l
                    ...
                    this.onMouseDown = function(e) {
                        ...
                        if (0 !== o) {
                            var r = n.getSelectionRange(),
                                s = r.isEmpty();
                            return s && n.selection.moveToPosition(i), void n.textInput.onContextMenu(e.domEvent)
                        }
                        ...
                        if (this.$clickSelection) {
                            ...
                            if (-1 == s && 0 >= a) t = this.$clickSelection.end, (r.end.row != n.row || r.end.column != n.column) && (n = r.start);
                            else if (1 == a && s >= 0) t = this.$clickSelection.start, (r.start.row != n.row || r.start.column != n.column) && (n = r.end);
                            else if (-1 == s && 1 == a) n = r.end, t = r.start;
                            else {
                        ...
                        o ? (o.isEmpty() && (o.start.column--, o.end.column++), this.setState("select")) : (o = i.selection.getWordRange(t.row, t.column), this.setState("selectByWords")), this.$clickSelection = o, this.select()
                ...
                function i(e) {
                    function t() {
                        ...
                        if (t == o) {
                            var s = a.renderer.pixelToScreenCoordinates(0, u.y).row,
                                h = u.$pos;
                            if (s > a.session.documentToScreenRow(h.row, h.column)) return i()
                        }
                        if (d != n)
                            if (d = n.text.join("<br/>"), c.setHtml(d), c.show(), a.on("mousewheel", i), e.$tooltipFollowsMouse) r(u);
                            else {
                    ...
                    function i() {
                        h && (h = clearTimeout(h)), d && (c.hide(), d = null, a.removeEventListener("mousewheel", i))
                    }
                        ...
                        if (a.isFocused() && 0 == t.getButton()) {
                            ...
                            if ("foldWidgets" != i) {
                                var n = t.getDocumentPosition().row,
                                    o = a.session.selection;
                                if (t.getShiftKey()) o.selectTo(n, 0);
                                else {
                    ...
                    e.editor.setDefaultHandler("guttermousemove", function(n) {
                        ...
                        return o.hasCssClass(s, "ace_fold-widget") ? i() : (d && e.$tooltipFollowsMouse && r(n), u = n, void(h || (h = setTimeout(function() {
                            h = null, u && !e.isMousePressed ? t() : i()
                        }, 50))))
                    ...
                    function() {
                        this.setPosition = function(e, t) {
                            var i = window.innerWidth || document.documentElement.clientWidth,
                                ...
                                o = this.getWidth(),
                                r = this.getHeight();
                            e += 15, t += 15, e + o > i && (e -= e + o - i), t + r > n && (t -= 20 + r), a.prototype.setPosition.call(this, e, t)
                        }
                ...
                function i(e) {
                    function t(e, t) {
                        ...
                        if (!B || o || r) m.$blockScrolling += 1, m.moveCursorToPosition(e), m.$blockScrolling -= 1, B = i, $ = {
                            x: C,
                            y: E
                        };
                        else {
                            var s = n($.x, $.y, C, E);
                            s > c ? B = null : i - B >= l && (m.renderer.scrollCursorIntoView(), B = null)
                        }
                    }
                    ...
                    function i(e, t) {
                        ...
                        2 >= l / o && (h.column += s.x.left < s.x.right ? -3 : 2), 1 >= c / n && (h.row += s.y.top < s.y.bottom ? -1 : 1);
                        var u = e.row != h.row,
                            d = e.column != h.column,
                            g = !t || e.row != t.row;
                        u || d && !g ? D ? i - D >= a && m.renderer.scrollCursorIntoView(h) : D = i : D = null
                    }

                    function h() {
                        var e = b;
                        b = m.renderer.screenToTextCoordinates(C, E), t(b, e), i(b, e)
                    }

                    function u() {
                        F = m.selection.toOrientedRange(), A = m.session.addMarker(F, "ace_selection", m.getSelectionStyle()), m.clearSelection(), m.isFocused() && m.renderer.$cursorLayer.setBlinking(!1), clearInterval(y), h(), y = setInterval(h, 20), _ = 0, r.addListener(document, "mousemove", g)
                    }

                    function d() {
                        clearInterval(y), m.session.removeMarker(A), A = null, m.$blockScrolling += 1, m.selection.fromOrientedRange(F), m.$blockScrolling -= 1, m.isFocused() && !S && m.renderer.$cursorLayer.setBlinking(!m.getReadOnly()), F = null, b = null, _ = 0, D = null, B = null, r.removeListener(document, "mousemove", g)
                    }
                    ...
                    function p(e) {
                        ...
                        var r = "none";
                        return n && t.indexOf(o) >= 0 ? r = "copy" : i.indexOf(o) >= 0 ? r = "move" : t.indexOf(o) >= 0 && (r = "copy"), r
                    }
                    var m = e.editor,
                    ...
                    var A, C, E, y, F, b, x, S, D, B, $, k = m.container,
                        _ = 0;
                    this.onDragStart = function(e) {
                        ...
                        F = m.getSelectionRange();
                        var i = e.dataTransfer;
                        i.effectAllowed = m.getReadOnly() ? "copy" : "copyMove", s.isOpera && (m.container.appendChild(v), v.scrollTop = 0), i.setDragImage && i.setDragImage(v, 0, 0), s.isOpera && m.container.removeChild(v), i.clearData(), i.setData("Text", m.session.getTextRange()), S = !0, this.setState("drag")
                        ...
                        return !m.getReadOnly() && f(e.dataTransfer) ? (C = e.clientX, E = e.clientY, A || u(), _++, e.dataTransfer.dropEffect = x = p(e), r.preventDefault(e)) : void 0
                    }, this.onDragOver = function(e) {
                        return !m.getReadOnly() && f(e.dataTransfer) ? (C = e.clientX, E = e.clientY, A || (u(), _++), null !== L && (L = null), e.dataTransfer.dropEffect = x = p(e), r.preventDefault(e)) : void 0
                    }, this.onDragLeave = function(e) {
                        return _--, 0 >= _ && A ? (d(), x = null, r.preventDefault(e)) : void 0
                    }, this.onDrop = function(e) {
                        if (b) {
                            var t = e.dataTransfer;
                            if (S) switch (x) {
                                case "move":
                                    F = F.contains(b.row, b.column) ? {
                                        start: b,
                                        end: b
                                    } : m.moveText(F, b);
                                    break;
                                ...
                                F = {
                                    start: b,
                                    end: m.session.insert(b, i)
                                }, m.focus(), x = null
                            }
                            return d(), r.preventDefault(e)
                        }
                    }, r.addListener(k, "dragstart", this.onDragStart.bind(e)), r.addListener(k, "dragend", this.onDragEnd.bind(e)), r.addListener(k, "dragenter", this.onDragEnter.bind(e)), r.addListener(k, "dragover", this.onDragOver.bind(e)), r.addListener(k, "dragleave", this.onDragLeave.bind(e)), r.addListener(k, "drop", this.onDrop.bind(e));
                    var L = null
                }
                ...
                i._emit = i._dispatchEvent = function(e, t) {
                    ...
                    if (i.length || r) {
                        "object" == typeof t && t || (t = {}), t.type || (t.type = e), t.stopPropagation || (t.stopPropagation = n), t.preventDefault || (t.preventDefault = o), i = i.slice();
                ...
                function o(o) {
                    if (u.packaged = o || e.packaged || n.packaged || h.define && i(17).packaged, !h.document) return "";
                    for (var s = {}, a = "", l = document.currentScript || document._currentScript, c = l && l.ownerDocument || document, d = c.getElementsByTagName("script"), g = 0; g < d.length; g++) {
                        var f = d[g],
                            p = f.src || f.getAttribute("src");
                        if (p) {
                            for (var m = f.attributes, v = 0, w = m.length; w > v; v++) {
                                var A = m[v];
                ...
                t.get = function(e) {
                ...
                }, a.implement(t, c), t.moduleUrl = function(e, t) {
                    ...
                    var s = u[t + "Path"];
                    return null == s ? s = u.basePath : "/" == n && (t = n = ""), s && "/" != s.slice(-1) && (s += "/"), s + t + n + o + this.get("suffix")
                    ...
                    if (t.$loading[i] || (t.$loading[i] = []), t.$loading[i].push(n), !(t.$loading[i].length > 1)) {
                        ...
                        return t.get("packaged") ? void l.loadScript(t.moduleUrl(i, r), a) : a()
                    }
                }, o(!0), t.init = o;
                var d = {
                        ...
                        setOption: function(e, t) {
                            if (this["$" + e] !== t) {
                                ...
                                if (!i) return void("undefined" != typeof console && console.warn && console.warn('misspelled option "' + e + '"'));
                ...
                t.defineOptions = function(e, t, i) {
                    return e.$options || (g[t] = e.$options = {}), Object.keys(i).forEach(function(t) {
                        var n = i[t];
                        "string" == typeof n && (n = {
                            forwardTo: n
                        }), n.name || (n.name = t), e.$options[n.name] = n, "initialValue" in n && (e["$" + n.name] = n.initialValue)
                    }), a.implement(e, d), this
                ...
                var i = e("../lib/event"),
                    ...
                    c = function(e) {
                        ...
                        i.addListener(l, "click", this.onMouseEvent.bind(this, "click")), i.addListener(l, "mousemove", this.onMouseMove.bind(this, "mousemove")), i.addMultiMouseDownListener(l, [400, 300, 250], this, "onMouseEvent"), e.renderer.scrollBarV && (i.addMultiMouseDownListener(e.renderer.scrollBarV.inner, [400, 300, 250], this, "onMouseEvent"), i.addMultiMouseDownListener(e.renderer.scrollBarH.inner, [400, 300, 250], this, "onMouseEvent"), n.isIE && (i.addListener(e.renderer.scrollBarV.element, "mousedown", s), i.addListener(e.renderer.scrollBarH.element, "mousemove", s))), i.addMouseWheelListener(e.container, this.onMouseWheel.bind(this, "mousewheel"));
                        var c = e.renderer.$gutter;
                        i.addListener(c, "mousedown", this.onMouseEvent.bind(this, "guttermousedown")), i.addListener(c, "click", this.onMouseEvent.bind(this, "gutterclick")), i.addListener(c, "dblclick", this.onMouseEvent.bind(this, "gutterdblclick")), i.addListener(c, "mousemove", this.onMouseEvent.bind(this, "guttermousemove")), i.addListener(l, "mousedown", s), i.addListener(c, "mousedown", function(t) {
                            ...
                            if (!t.state && !t.$dragDelay && t.$dragEnabled) {
                                var n = e.renderer.screenToTextCoordinates(i.x, i.y),
                                    ...
                                    r = e.renderer;
                                r.setCursorStyle(!o.isEmpty() && o.insideStart(n.row, n.column) ? "default" : "")
                            }
                        })
                    };
                (function() {
                    this.onMouseEvent = function(e, t) {
                        ...
                        var r = this,
                            a = function(e) {
                                if (e) {
                                    if (n.isWebKit && !e.which && r.releaseMouse) return r.releaseMouse();
                        ...
                        r.$onCaptureMouseMove = a, r.releaseMouse = i.capture(this.editor.container, a, l);
                ...
                (function() {
                    this.setDefaultHandler = function(e) {
                        ...
                        for (var r, s = !1, a = this.$editor.commands, l = this.$handlers.length; l-- && (r = this.$handlers[l].handleKeyboard(this.$data, e, t, i, o), !(r && r.command && (s = "null" == r.command ? !0 : a.exec(r.command, this.$editor, r.args, o), s && o && -1 != e && 1 != r.passEvent && 1 != r.command.passEvent && n.stopEvent(o), s))););
                        return s
                ...
                (function() {
                    i.implement(this, o), this.isEmpty = function() {
                        ...
                        var i, n = "number" == typeof e ? e : this.lead.row,
                            o = this.session.getFoldLine(n);
                        return o ? (n = o.start.row, i = o.end.row) : i = n, t === !0 ? new r(n, 0, i, this.session.getLine(i).length) : new r(n, 0, i + 1, 0)
                        ...
                        return this.session.nonTokenRe.lastIndex = 0, this.session.tokenRe.lastIndex = 0, (r = this.session.nonTokenRe.exec(s)) && (i -= this.session.nonTokenRe.lastIndex, s = s.slice(this.session.nonTokenRe.lastIndex), this.session.nonTokenRe.lastIndex = 0), 0 >= i ? (this.moveCursorTo(t, 0), this.moveCursorLeft(), void(t > 0 && this.moveCursorWordLeft())) : ((r = this.session.tokenRe.exec(s)) && (i -= this.session.tokenRe.lastIndex, this.session.tokenRe.lastIndex = 0), void this.moveCursorTo(t, i))
                    }, this.$shortWordEndIndex = function(e) {
                        var t, i, n = 0,
                            o = /\s/,
                            r = this.session.tokenRe;
                        if (r.lastIndex = 0, t = this.session.tokenRe.exec(e)) n = this.session.tokenRe.lastIndex;
                        else {
                            for (;
                                (i = e[n]) && o.test(i);) n++;
                            if (1 > n)
                        ...
                        if (t == i.length) {
                            ...
                            do e++, n = this.doc.getLine(e); while (r > e && /^\s*$/.test(n));
                            /^\s+/.test(n) || (n = ""), t = 0
                        }
                        ...
                        for (var t in this.states) {
                            for (var i = this.states[t], n = [], o = 0, r = this.matchMappings[t] = {
                                ...
                                if (c.defaultToken && (r.defaultToken = c.defaultToken), c.caseInsensitive && (s = "gi"), null != c.regex) {
                                    ...
                                    }) : (u = 1, h = this.removeCapturingGroups(c.regex)), c.splitRegex || "string" == typeof c.token || a.push(c)), r[o] = l, o += u, n.push(h), c.onMatch || (c.onMatch = null)
                                }
                            }
                ...
                (function() {
                    this.$setMaxTokenCount = function(e) {
                        ...
                        for (var n = [], o = 0, r = i.length; r > o; o++) t[o] && (n[n.length] = {
                            type: i[o],
                            value: t[o]
                        });
                        return n
                        ...
                        if (!t) return "text";
                        for (var i = [], n = this.tokenArray, o = 0, r = n.length; r > o; o++) t[o + 1] && (i[i.length] = {
                            type: n[o],
                            value: t[o + 1]
                        });
                        return i
                        ...
                        for (var l, c = [], h = 0, u = 0, d = {
                            ...
                            for (var w = 0; w < l.length - 2; w++)
                                if (void 0 !== l[w + 1]) {
                                    f = r[s[w]], g = f.onMatch ? f.onMatch(p, o, n) : f.token, f.next && (o = "string" == typeof f.next ? f.next : f.next(o, n), r = this.states[o], r || (this.reportError("state doesn't exist", o), o = "start", r = this.states[o]), s = this.matchMappings[o], h = m, a = this.regExps[o], a.lastIndex = m);
                                    break
                                }
                            if (p)
                                if ("string" == typeof g) f && f.merge === !1 || d.type !== g ? (d.type && c.push(d), d = {
                                    type: g,
                                    value: p
                                }) : d.value += p;
                                else if (g) {
                                ...
                                for (var w = 0; w < g.length; w++) c.push(g[w])
                            }
                            if (h == e.length) break;
                            if (h = m, u++ > i) {
                        ...
                        return d.type && c.push(d), n.length > 1 && n[0] !== o && n.unshift("#tmp", o), {
                            tokens: c,
                            state: n.length ? n : o
                        }
                ...
                (function() {
                    this.addRules = function(e, t) {
                        ...
                        if (this.addRules(s, t), n)
                            for (var c = Array.prototype[r ? "push" : "unshift"], a = 0; a < o.length; a++) c.apply(this.$rules[o[a]], i.deepCopy(n));
                    ...
                    this.normalizeRules = function() {
                        function i(r) {
                            ...
                            for (var a = 0; a < s.length; a++) {
                                ...
                                if (c && Array.isArray(c)) {
                                    var h = l.stateName;
                                    h || (h = l.token, "string" != typeof h && (h = h[0] || ""), o[h] && (h += n++)), o[h] = c, l.next = h, i(h)
                                } else "pop" == c && (l.next = t);
                                if (l.push && (l.nextState = l.next || l.push, l.next = e, delete l.push), l.rules)
                                    for (var u in l.rules) o[u] ? o[u].push && o[u].push.apply(o[u], l.rules[u]) : o[u] = l.rules[u];
                        ...
                        return Object.keys(e).forEach(function(t) {
                            var r = e[t];
                            i && (r = r.toLowerCase());
                            for (var s = r.split(n || "|"), a = s.length; a--;) o[s[a]] = t
                        }), Object.getPrototypeOf(o) && (o.__proto__ = null), this.$keywordList = Object.keys(o), e = null, i ? function(e) {
                ...
                var i = e("../tokenizer").Tokenizer,
                    ...
                    l = e("../range").Range,
                    c = function() {
                        this.HighlightRules = n, this.$behaviour = new o
                    };
                (function() {
                    this.tokenRe = new RegExp("^[" + r.packages.L + r.packages.Mn + r.packages.Mc + r.packages.Nd + r.packages.Pc + "\\$_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + r.packages.L + r.packages.Mn + r.packages.Mc + r.packages.Nd + r.packages.Pc + "\\$_]|\\s])+", "g"), this.getTokenizer = function() {
                        ...
                        function o(e) {
                            for (var t = i; n >= t; t++) e(r.getLine(t), t)
                        }
                        var r = t.doc,
                            a = !0,
                            l = !0,
                        ...
                        if (this.lineCommentStart) {
                            ...
                            var f = function(e, t) {
                                    ...
                                    if (i) {
                                        var n = i[1].length,
                                            o = i[0].length;
                                        w(e, n, o) || " " != i[0][o - 1] || o--, r.removeInLine(t, n, o)
                                    }
                                },
                                p = g + " ",
                                m = function(e, t) {
                                    (!a || /\S/.test(e)) && (w(e, c, c) ? r.insertInLine({
                                        row: t,
                                        column: c
                                    }, p) : r.insertInLine({
                                        row: t,
                            ...
                            var g = this.blockComment.start,
                                ...
                                C = new RegExp("(?:" + s.escapeRegExp(A) + ")\\s*$"),
                                m = function(e, t) {
                                ...
                                f = function(e, t) {
                                    var i;
                                    (i = e.match(C)) && r.removeInLine(t, e.length - i[0].length, e.length), (i = e.match(d)) && r.removeInLine(t, i[1].length, i[0].length)
                                },
                                v = function(e, i) {
                                    if (d.test(e)) return !0;
                                    for (var n = t.getTokens(i), o = 0; o < n.length; o++)
                                        if ("comment" === n[o].type) return !0
                                }
                        }
                        var E = 1 / 0;
                        o(function(e, t) {
                            var i = e.search(/\S/); - 1 !== i ? (c > i && (c = i), l && !v(e, t) && (l = !1)) : E > e.length && (E = e.length)
                        }), 1 / 0 == c && (c = E, a = !1, l = !1), u && c % h != 0 && (c = Math.floor(c / h) * h), o(l ? f : m)
                    }, this.toggleBlockComment = function(e, t, i, n) {
                        var o = this.blockComment;
                        if (o) {
                            !o.start && o[0] && (o = o[0]);
                            var r, s, c = new a(t, n.row, n.column),
                                h = c.getCurrentToken(),
                            ...
                            if (h && /comment/.test(h.type)) {
                                for (var d, g; h && /comment/.test(h.type);) {
                                    ...
                                    if (-1 != f) {
                                        ...
                                        d = new l(p, m, p, m + o.start.length);
                                        break
                                    }
                                    h = c.stepBackward()
                                }
                                for (var c = new a(t, n.row, n.column), h = c.getCurrentToken(); h && /comment/.test(h.type);) {
                                    ...
                                    if (-1 != f) {
                                        var p = c.getCurrentTokenRow(),
                                            m = c.getCurrentTokenColumn() + f;
                                        g = new l(p, m, p, m + o.end.length);
                                        break
                                    }
                                    h = c.stepForward()
                                }
                                g && t.remove(g), d && (t.remove(d), r = d.start.row, s = -o.start.length)
                            } else s = o.start.length, r = i.start.row, t.insert(i.end, o.end), t.insert(i.start, o.start);
                        ...
                        if (!this.completionKeywords) {
                            ...
                            for (var n in t)
                                for (var o = t[n], r = 0, s = o.length; s > r; r++)
                                    if ("string" == typeof o[r].token) / keyword | support | storage / .test(o[r].token) && i.push(o[r].regex);
                    ...
                    i.implement(this, n), this.getPosition = function() {
                        ...
                        if ((i.start.row != i.end.row || i.start.row == this.row) && !(i.start.row > this.row || i.start.row == this.row && i.start.column > this.column)) {
                            var n = this.row,
                                ...
                                r = i.start,
                                s = i.end;
                            "insertText" === t.action ? r.row === n && r.column <= o ? r.column === o && this.$insertRight || (r.row === s.row ? o += s.column - r.column : (o -= r.column, n += s.row - r.row)) : r.row !== s.row && r.row < n && (n += s.row - r.row) : "insertLines" === t.action ? r.row === n && 0 === o && this.$insertRight || r.row <= n && (n += s.row - r.row) : "removeText" === t.action ? r.row === n && r.column < o ? o = s.column >= o ? r.column : Math.max(0, o - (s.column - r.column)) : r.row !== s.row && r.row < n ? (s.row === n && (o = Math.max(0, o - s.column) + r.column), n -= s.row - r.row) : s.row === n && (n -= s.row - r.row, o = Math.max(0, o - s.column) + r.column) : "removeLines" == t.action && r.row <= n && (s.row <= n ? n -= s.row - r.row : (n = r.row, o = 0)), this.setPosition(n, o, !0)
                        }
                ...
                (function() {
                    i.implement(this, n), this.setValue = function(e) {
                        ...
                        return e = this.insertInLine(e, n), null !== o && (e = this.insertNewLine(e), e = this._insertLines(e.row, i), e = this.insertInLine(e, o || "")), e
                        ...
                        if (e.isMultiLine()) {
                            var n = 0 == e.start.column ? t : t + 1,
                                r = i - 1;
                            e.end.column > 0 && this.removeInLine(i, 0, e.end.column), r >= n && this._removeLines(n, r), n != t && (this.removeInLine(t, e.start.column, this.getLine(t).length), this.removeNewLine(e.start.row))
                        ...
                        if (t != i) {
                            var n = new o(e, t, e, i),
                                r = this.getLine(e),
                                s = r.substring(t, i),
                                a = r.substring(0, t) + r.substring(i, r.length);
                        ...
                        for (var t = 0; t < e.length; t++) {
                            var i = e[t],
                                n = o.fromPoints(i.range.start, i.range.end);
                        ...
                        for (var i = this.$lines || this.getAllLines(), n = this.getNewLineCharacter().length, o = 0, r = Math.min(e.row, i.length), s = t || 0; r > s; ++s) o += i[s].length + n;
                        return o + e.column
                    }
                ...
                var i = e("./lib/oop"),
                    ...
                    o = function(e) {
                        ...
                        this.$worker = function() {
                            if (t.running) {
                                for (var e = new Date, i = t.currentLine, n = -1, o = t.doc; t.lines[i];) i++;
                                var r = i,
                                    s = o.getLength(),
                                    a = 0;
                                for (t.running = !1; s > i;) {
                                ...
                                t.currentLine = i, n >= r && t.fireUpdateEvent(r, n)
                            }
                        }
                    };
                (function() {
                    ...
                    this.MAX_RANGES = 500, this.setRegexp = function(e) {
                        ...
                        if (this.regExp)
                            for (var s = r.firstRow, a = r.lastRow, l = s; a >= l; l++) {
                                ...
                                for (var h = c.length; h--;) t.drawSingleLineMarker(e, c[h].toScreenRange(o), this.clazz, r)
                            }
                    }
                ...
                (function() {
                    this.shiftRow = function(e) {
                        ...
                        for (var c = 0; c < a.length; c++) {
                            if (n = a[c], o = n.range.compareStart(t, i), -1 == o) return void e(null, t, i, s, l);
                            if (r = e(null, n.start.row, n.start.column, s, l), r = !r && e(n.placeholder, n.start.row, n.start.column, s), r || 0 === o) return;
                            l = !n.sameRow, s = n.end.column
                        }
                        e(null, t, i, s, l)
                    }, this.getNextFoldTo = function(e, t) {
                        for (var i, n, o = 0; o < this.folds.length; o++) {
                            if (i = this.folds[o], n = i.range.compareEnd(e, t), -1 == n) return {
                                fold: i,
                                kind: "after"
                            };
                            if (0 === n) return {
                        ...
                        if (r)
                            if (n = r.fold, "inside" == r.kind && n.start.column != t && n.start.row != e) window.console && window.console.log(e, t, n);
                            else if (n.start.row == e) {
                            o = this.folds;
                            var s = o.indexOf(n);
                            for (0 === s && (this.start.column += i), s; s < o.length; s++) {
                                if (n = o[s], n.start.column += i, !n.sameRow) return;
                                n.end.column += i
                            }
                            this.end.column += i
                        }
                ...
                (function() {
                    this.comparePoints = n, this.pointIndex = function(e, t, i) {
                        ...
                        0 > o && (o = -o - 1);
                        for (var r = [], s = n; o > s; s++) r.push(i[s]);
                        return r
                        ...
                        for (var o = i.row, r = n.row, s = r - o, a = -i.column + n.column, l = this.ranges, c = 0, h = l.length; h > c; c++) {
                            ...
                            if (!(u.end.row < o)) {
                                ...
                                if (u.start.row == o && u.start.column >= i.column && (u.start.column == i.column && this.$insertRight || (u.start.column += a, u.start.row += s)), u.end.row == o && u.end.column >= i.column) {
                                    if (u.end.column == i.column && this.$insertRight) continue;
                                    u.end.column == i.column && a > 0 && h - 1 > c && u.end.column > u.start.column && u.end.column == l[c + 1].start.column && (u.end.column -= a), u.end.column += a, u.end.row += s
                                }
                            }
                        }
                        if (0 != s && h > c)
                ...
                function i() {
                    this.getFoldAt = function(e, t, i) {
                        ...
                        return s || (p = this.$addFoldLine(new o(this.$foldData, i))), this.$useWrapMode ? this.$updateWrapData(p.start.row, p.start.row) : this.$updateRowLengthCache(p.start.row, p.start.row), this.$modified = !0, this._emit("changeFold", {
                            data: i,
                            action: "add"
                        }), i
                        ...
                        var i, o;
                        if (null == e ? (i = new n(0, 0, this.getLength(), 0), t = !0) : i = "number" == typeof e ? new n(e, 0, e, this.getLine(e).length) : "row" in e ? n.fromPoints(e, e) : e, o = this.getFoldsInRangeList(i), t) this.removeFolds(o);
                        else
                            for (var r = o; r.length;) this.expandFolds(r), r = this.getFoldsInRangeList(i);
                        ...
                        null == n && (n = e.start.row), null == o && (o = 0), null == t && (t = e.end.row), null == i && (i = this.getLine(t).length);
                        var r = this.doc,
                            s = "";
                        ...
                        if (o) return this.getFoldDisplayLine(o, e, t, i, n);
                        var r;
                        ...
                        if (o.isEmpty()) {
                            ...
                            (i = this.findMatchingBracket(r)) ? 1 == o.comparePoint(i) ? o.end = i : (o.start = i, o.start.column++, o.end.column--): (i = this.findMatchingBracket({
                                row: r.row,
                                column: r.column + 1
                            })) ? (1 == o.comparePoint(i) ? o.end = i : o.start = i, o.start.column++) : o = this.getCommentFoldRange(r.row, r.column) || o
                        } else {
                            var s = this.getFoldsInRange(o);
                            if (e && s.length) return void this.expandFolds(s);
                            1 == s.length && (t = s[0])
                        }
                        if (t || (t = this.getFoldAt(o.start.row, o.start.column)), t && t.range.toString() == o.toString()) return void this.expandFold(t);
                        var a = "...";
                        if (!o.isMultiLine()) {
                        ...
                        if (this.$foldMode != e) {
                            if (this.$foldMode = e, this.removeListener("change", this.$updateFoldWidgets), this._emit("changeAnnotation"), !e || "manual" == this.$foldStyle) return void(this.foldWidgets = null);
                        ...
                        if (this.getFoldWidget) {
                            ...
                            if (r) return void(t.children || t.all ? this.removeFold(r) : this.expandFold(r));
                            var s = this.getFoldWidgetRange(e, !0);
                            if (s && !s.isMultiLine() && (r = this.getFoldAt(s.start.row, s.start.column, 1), r && s.isEqual(r.range))) return void this.removeFold(r);
                            if (t.siblings) {
                                var a = this.getParentFoldRangeData(e);
                                if (a.range) var l = a.range.start.row + 1,
                                    c = a.range.end.row;
                                this.foldAll(l, c, t.all ? 1e4 : 0)
                            } else t.children ? (c = s ? s.end.row : this.getLength(), this.foldAll(e + 1, s.end.row, t.all ? 1e4 : 0)) : s && (t.all && (s.collapseChildren = 1e4), this.addFold("...", s));
                            return s
                        }
                        ...
                        var t = e.data,
                            ...
                            n = i.start.row,
                            o = i.end.row - n;
                        if (0 === o) this.foldWidgets[n] = null;
                        else if ("removeText" == t.action || "removeLines" == t.action) this.foldWidgets.splice(n, o + 1, null);
                        else {
                            var r = Array(o + 1);
                ...
                (function() {
                    ...
                    i.implement(this, r), this.setDocument = function(e) {
                        ...
                        var i, n = this.bgTokenizer.getTokens(e),
                            o = 0;
                        if (null == t) r = n.length - 1, o = this.getLine(e).length;
                        else
                            for (var r = 0; r < n.length && (o += n[r].value.length, !(o >= t)); r++);
                        return (i = n[r]) ? (i.index = r, i.start = o - i.value.length, i) : null
                        ...
                        return n ? (this.$frontMarkers[o] = r, this._signal("changeFrontMarker")) : (this.$backMarkers[o] = r, this._signal("changeBackMarker")), o
                        ...
                        var i = this.getLine(e),
                            n = !1;
                        if (t > 0 && (n = !!i.charAt(t - 1).match(this.tokenRe)), n || (n = !!i.charAt(t).match(this.tokenRe)), n) var o = this.tokenRe;
                        else if (/^\s+$/.test(i.slice(t - 1, t + 1))) var o = /\s/;
                        else var o = this.nonTokenRe;
                        var r = t;
                        if (r > 0) {
                            do r--; while (r >= 0 && i.charAt(r).match(o));
                            r++
                        }
                        for (var s = t; s < i.length && i.charAt(s).match(o);) s++;
                        ...
                        return this.$modes["ace/mode/text"] || (this.$modes["ace/mode/text"] = new a), this.$modes[n] && !i ? (this.$onChangeMode(this.$modes[n]), void(t && t())) : (this.$modeId = n, o.loadModule(["mode", n], function(e) {
                        ...
                        var o, r, s = e[0],
                            a = !1;
                        n(s) ? (o = l.fromPoints(s.range.start, s.range.end), a = !0) : (o = l.fromPoints(s.range.start, s.range.start), a = !1);
                        for (var c = 1; c < e.length; c++) s = e[c], n(s) ? (r = s.range.start, -1 == o.compare(r.row, r.column) && o.setStart(s.range.start), r = s.range.end, 1 == o.compare(r.row, r.column) && o.setEnd(s.range.end), a = !0) : (r = s.range.start, -1 == o.compare(r.row, r.column) && (o = l.fromPoints(s.range.start, s.range.start)), a = !1);
                        if (null != i) {
                            0 === l.comparePoints(i.start, o.start) && (i.start.column += o.end.column - o.start.column, i.end.column += o.end.column - o.start.column);
                        ...
                        if (r.end = this.insert(r.start, n), o.length) {
                            var c = e.start,
                                h = r.start,
                                s = h.row - c.row,
                                a = h.column - c.column;
                        ...
                        var r = new l(e, 0, t, Number.MAX_VALUE),
                        ...
                        var t, i = this.$useWrapMode,
                            n = e.data.action,
                            o = e.data.range.start.row,
                            r = e.data.range.end.row,
                        ...
                        if (-1 != n.indexOf("Lines") ? (r = "insertLines" == n ? o + e.data.lines.length : o, t = e.data.lines ? e.data.lines.length : r - o) : t = r - o, this.$updating = !0, 0 != t)
                            if (-1 != n.indexOf("remove")) {
                                ...
                                var c = this.$foldData,
                                    ...
                                    u = 0;
                                if (h) {
                                    var p = h.range.compareInside(s.row, s.column);
                                    0 == p ? (h = h.split(s.row, s.column), h && (h.shiftRow(t), h.addRemoveChars(r, 0, a.column - s.column))) : -1 == p && (h.addRemoveChars(o, 0, a.column - s.column), h.shiftRow(t)), u = c.indexOf(h) + 1
                                }
                                for (u; u < c.length; u++) {
                                    var h = c[u];
                        ...
                        var i, n, o = this.doc.getAllLines(),
                            r = this.getTabSize(),
                            s = this.$wrapData,
                            a = this.$wrapLimit,
                            l = e;
                        for (t = Math.min(t, o.length - 1); t >= l;) n = this.getFoldLine(l, n), n ? (i = [], n.walk(function(e, t, n, r) {
                            var s;
                            if (null != e) {
                                s = this.$getDisplayTokens(e, i.length), s[0] = c;
                                for (var a = 1; a < s.length; a++) s[a] = d
                            } else s = this.$getDisplayTokens(o[t].substring(r, n), i.length);
                            i = i.concat(s)
                        }.bind(this), n.end.row, o[n.end.row].length + 1), s[n.start.row] = this.$computeWrapSplits(i, a, r), l = n.end.row + 1) : (i = this.$getDisplayTokens(o[l]), s[l] = this.$computeWrapSplits(i, a, r), l++)
                    };
                    var t = 1,
                        s = 2,
                        c = 3,
                    ...
                    this.$computeWrapSplits = function(e, t) {
                        ...
                        for (var n = [], o = e.length, r = 0, a = 0, l = this.$wrapAsCode; o - r > t;) {
                            var h = r + t;
                            if (e[h - 1] >= f && e[h] >= f) i(h);
                            else if (e[h] != c && e[h] != d) {
                                for (var u = Math.max(h - (l ? 10 : t - (t >> 2)), r - 1); h > u && e[h] < c;) h--;
                                if (l) {
                                    for (; h > u && e[h] < c;) h--;
                                    for (; h > u && e[h] == g;) h--
                                } else
                                    for (; h > u && e[h] < f;) h--;
                                h > u ? i(++h) : (h = r + t, e[h] == s && h--, i(h))
                            } else {
                                for (h; h != r - 1 && e[h] != c; h--);
                                if (h > r) {
                                    i(h);
                        ...
                        for (var a = 0; a < i.length; a++) {
                            ...
                            if (9 == l) {
                                o = this.getScreenTabSize(r.length + n), r.push(p);
                                for (var c = 1; o > c; c++) r.push(m)
                            } else 32 == l ? r.push(f) : l > 39 && 48 > l || l > 57 && 64 > l ? r.push(g) : l >= 4352 && e(l) ? r.push(t, s) : r.push(t)
                        }
                        return r
                        ...
                        null == i && (i = 1 / 0), n = n || 0;
                        var o, r;
                        for (r = 0; r < t.length && (o = t.charCodeAt(r), n += 9 == o ? this.getScreenTabSize(n) : o >= 4352 && e(o) ? 2 : 1, !(n > i)); r++);
                        return [n, r]
                        ...
                        for (var d = this.getLength() - 1, g = this.getNextFoldLine(o), f = g ? g.start.row : 1 / 0; e >= s && (a = this.getRowLength(o), !(s + a > e || o >= d));) s += a, o++, o > f && (o = g.end.row + 1, g = this.getNextFoldLine(o, g), f = g ? g.start.row : 1 / 0), u && (this.$docRowCache.push(o), this.$screenRowCache.push(s));
                        if (g && g.start.row <= o) i = this.getFoldDisplayLine(g), o = g.start.row;
                        else {
                            if (e >= s + a || o > d) return {
                                row: d,
                                column: this.getLine(d).length
                            };
                            i = this.getLine(o), g = null
                        }
                        if (this.$useWrapMode) {
                            var p = this.$wrapData[o];
                            if (p) {
                                var m = Math.floor(e - s);
                                n = p[m], m > 0 && p.length && (r = p[m - 1] || p[p.length - 1], i = i.substring(r))
                            }
                        }
                        return r += this.$getStringScreenWidth(i, t)[1], this.$useWrapMode && r >= n && (r = n - 1), g ? g.idxToPosition(r) : {
                            row: o,
                            column: r
                        }
                        ...
                        for (var d = this.getNextFoldLine(a), g = d ? d.start.row : 1 / 0; e > a;) {
                            ...
                            n += this.getRowLength(a), a = s, u && (this.$docRowCache.push(a), this.$screenRowCache.push(n))
                        }
                        var f = "";
                        if (d && a >= g ? (f = this.getFoldDisplayLine(d, e, t), o = d.start.row) : (f = this.getLine(e).substring(0, t), o = e), this.$useWrapMode) {
                            var p = this.$wrapData[o];
                            if (p) {
                                for (var m = 0; f.length >= p[m];) n++, m++;
                        ...
                        if (this.$useWrapMode)
                            for (var i = this.$wrapData.length, n = 0, o = 0, t = this.$foldData[o++], r = t ? t.start.row : 1 / 0; i > n;) {
                                ...
                                e += s ? s.length + 1 : 1, n++, n > r && (n = t.end.row + 1, t = this.$foldData[o++], r = t ? t.start.row : 1 / 0)
                            } else {
                                e = this.getLength();
                                for (var a = this.$foldData, o = 0; o < a.length; o++) t = a[o], e -= t.end.row - t.start.row
                            }
                    ...
                    this.set = function(e) {
                        ...
                        if (t.$isMultiLine) {
                            ...
                            e: for (var u = a.offset || 0; h >= u; u++) {
                                ...
                                l && l.end.row === u && l.end.column > p || (s.push(l = new o(u, p, u + c - 1, m)), c > 2 && (u = u + c - 2))
                            }
                        } else
                            for (var v = 0; v < r.length; v++)
                                for (var w = i.getMatchOffsets(r[v], a), d = 0; d < w.length; d++) {
                                    var A = w[d];
                                    s.push(new o(v, A.offset, v, A.offset + A.length))
                                }
                        if (n) {
                            for (var C = n.start.column, E = n.start.column, v = 0, d = s.length - 1; d > v && s[v].start.column < C && s[v].start.row == n.start.row;) v++;
                            for (; d > v && s[d].end.column > E && s[d].end.row == n.end.row;) d--;
                            for (s = s.slice(v, d + 1), v = 0, d = s.length; d > v; v++) s[v].start.row += n.start.row, s[v].end.row += n.start.row
                        }
                        return s
                    }, this.replace = function(e, t) {
                        var i = this.$options,
                        ...
                        if (t.$isMultiLine) var l = n.length,
                            c = function(t, i, s) {
                                ...
                                if (-1 != a) {
                                    for (var c = 1; l > c; c++)
                                        if (t = e.getLine(i + c), -1 == t.search(n[c])) return;
                                    var h = t.match(n[l - 1])[0].length,
                                        u = new o(i, a, i + l - 1, h);
                                    return 1 == n.offset ? (u.start.row--, u.start.column = Number.MAX_VALUE) : s && (u.start.column += s), r(u) ? !0 : void 0
                                }
                            };
                        else if (a) var c = function(e, t, o) {
                            for (var s = i.getMatchOffsets(e, n), a = s.length - 1; a >= 0; a--)
                                if (r(s[a], t, o)) return !0
                        };
                        ...
                        this.addCommand = function(e) {
                            ...
                            for (var o in n) {
                                ...
                                if (r == e) delete n[o];
                                    ...
                                    var s = r.indexOf(e); - 1 != s && (r.splice(s, 1), 1 == r.length && (n[o] = r[0]))
                                }
                            }
                            ...
                            var n, o = this.commandKeyBinding;
                            t ? !o[e] || this.$singleCommand ? o[e] = t : (Array.isArray(o[e]) ? -1 != (n = o[e].indexOf(t)) && o[e].splice(n, 1) : o[e] = [o[e]], i || t.isDefault ? o[e].unshift(t) : o[e].push(t)) : delete o[e]
                            ...
                            return e.$keyChain && (e.$keyChain += " " + o, r = this.commandKeyBinding[e.$keyChain] || r), !r || "chainKeys" != r && "chainKeys" != r[r.length - 1] ? (e.$keyChain && n > 0 && (e.$keyChain = ""), {
                                command: r
                ...
                t.commands = [{
                    ...
                    bindKey: i(null, null),
                    exec: function(e) {
                        for (var t = e.selection.isBackwards(), i = t ? e.selection.getSelectionLead() : e.selection.getSelectionAnchor(), o = t ? e.selection.getSelectionAnchor() : e.selection.getSelectionLead(), s = e.session.doc.getLine(i.row).length, a = e.session.doc.getTextRange(e.selection.getRange()), l = a.replace(/\n\s*/, " ").length, c = e.session.doc.getLine(i.row), h = i.row + 1; h <= o.row + 1; h++) {
                            var u = n.stringTrimLeft(n.stringTrimRight(e.session.doc.getLine(h)));
                            0 !== u.length && (u = " " + u), c += u
                        }
                        o.row + 1 < e.session.doc.getLength() - 1 && (c += e.session.doc.getNewLineCharacter()), e.clearSelection(), e.session.doc.replace(new r(i.row, 0, o.row + 2, 0), c), l > 0 ? (e.selection.moveCursorTo(i.row, i.column), e.selection.selectTo(i.row, i.column + l)) : (s = e.session.doc.getLine(i.row).length > s ? s + 1 : s, e.selection.moveCursorTo(i.row, s))
                    },
                    multiSelectAction: "forEach",
                    readOnly: !0
                }, {
                    ...
                    exec: function(e) {
                        ...
                        for (var s = 0; s < n.length; s++) s == n.length - 1 && (n[s].end.row !== t || n[s].end.column !== i) && o.push(new r(n[s].end.row, n[s].end.column, t, i)), 0 === s ? (0 !== n[s].start.row || 0 !== n[s].start.column) && o.push(new r(0, 0, n[s].start.row, n[s].start.column)) : o.push(new r(n[s - 1].end.row, n[s - 1].end.column, n[s].start.row, n[s].start.column));
                        e.exitMultiSelectMode(), e.clearSelection();
                        for (var s = 0; s < o.length; s++) e.selection.addRange(o[s], !1)
                    },
                    readOnly: !0,
                    scrollIntoView: "none"
                }]
                ...
                var i = e("./lib/oop"),
                    ...
                    w = function(e, t) {
                        ...
                        this.container = i, this.renderer = e, this.commands = new f(r.isMac ? "mac" : "win", p), this.textInput = new s(e.getTextAreaContainer(), this), this.renderer.textarea = this.textInput.getElement(), this.keyBinding = new c(this), this.$mouseHandler = new a(this), new l(this), this.$blockScrolling = 0, this.$search = (new u).set({
                            wrap: !0
                        ...
                        }), this.setSession(t || new h("")), m.resetOptions(this), m._signal("editor", this)
                    };
                (function() {
                    i.implement(this, g), this.$initOperationListeners = function() {
                        ...
                        if (this.$mergeUndoDeltas) {
                            ...
                            if ("insertstring" == e.command.name) {
                                var o = e.args;
                                void 0 === this.mergeNextCommand && (this.mergeNextCommand = !0), n = n && this.mergeNextCommand && (!/\s/.test(o) || /\s/.test(t.args)), this.mergeNextCommand = !0
                            ...
                            this.$highlightTagPending = !0, setTimeout(function() {
                                ...
                                if (t && t.bgTokenizer) {
                                    var i = e.getCursorPosition(),
                                        n = new v(e.session, i.row, i.column),
                                        o = n.getCurrentToken();
                                    if (!o || -1 === o.type.indexOf("tag-name")) return t.removeMarker(t.$tagHighlight), void(t.$tagHighlight = null);
                                    var r = o.value,
                                        s = 0,
                                        a = n.stepBackward();
                                    if ("<" == a.value) {
                                        do a = o, o = n.stepForward(), o && o.value === r && -1 !== o.type.indexOf("tag-name") && ("<" === a.value ? s++ : "</" === a.value && s--); while (o && s >= 0)
                                    } else {
                                        do o = a, a = n.stepBackward(), o && o.value === r && -1 !== o.type.indexOf("tag-name") && ("<" === a.value ? s++ : "</" === a.value && s--); while (a && 0 >= s);
                                        n.stepForward()
                                    }
                                    if (!o) return t.removeMarker(t.$tagHighlight), void(t.$tagHighlight = null);
                                    var l = n.getCurrentTokenRow(),
                                        c = n.getCurrentTokenColumn(),
                                        h = new d(l, c, l, c + o.value.length);
                        ...
                        this.clearSelection(); {
                            var c = o.column,
                                h = i.getState(o.row),
                                a = i.getLine(o.row),
                                u = n.checkOutdent(h, a, e);
                            i.insert(o, e)
                        }
                        if (r && r.selection && this.selection.setSelectionRange(2 == r.selection.length ? new d(o.row, c + r.selection[0], o.row, c + r.selection[1]) : new d(o.row + r.selection[0], r.selection[1], o.row + r.selection[2], r.selection[3])), i.getDocument().isNewLine(e)) {
                            var g = n.getNextLineIndent(h, a.slice(0, o.column), i.getTabString());
                            i.insert({
                                row: o.row + 1,
                                column: 0
                            }, g)
                        }
                        u && n.autoOutdent(h, i, o.row)
                    }, this.onTextInput = function(e) {
                        ...
                        if (this.selection.isEmpty()) {
                            ...
                            if (0 !== t) {
                                ...
                                t < o.length ? (i = o.charAt(t) + o.charAt(t - 1), n = new d(e.row, t - 1, e.row, t + 1)) : (i = o.charAt(t - 1) + o.charAt(t - 2), n = new d(e.row, t - 2, e.row, t)), this.session.replace(n, i)
                            }
                        }
                        ...
                        if (this.session.getUseSoftTabs()) var c = a - l % a,
                            ...
                            for (var c = l % a;
                                " " == r[t.start.column] && c;) t.start.column--, c--;
                        ...
                        for (var n = new d(0, 0, 0, 0), o = e.first; o <= e.last; o++) {
                            var r = t.getLine(o);
                        ...
                        if (r) {
                            ...
                            if (s) {
                                var g, f;
                                if ("bracket" === s) g = this.session.getBracketRange(i), g || (g = new d(n.getCurrentTokenRow(), n.getCurrentTokenColumn() + h - 1, n.getCurrentTokenRow(), n.getCurrentTokenColumn() + h - 1), f = g.start, (t || f.row === i.row && Math.abs(f.column - i.column) < 2) && (g = this.session.getBracketRange(f)));
                                else if ("tag" === s) {
                                    ...
                                    if (g = new d(n.getCurrentTokenRow(), n.getCurrentTokenColumn() - 2, n.getCurrentTokenRow(), n.getCurrentTokenColumn() - 2), 0 === g.compare(i.row, i.column)) {
                                        l = !1;
                                        do r = o, o = n.stepBackward(), o && (-1 !== o.type.indexOf("tag-close") && g.setEnd(n.getCurrentTokenRow(), n.getCurrentTokenColumn() + 1), r.value === p && -1 !== r.type.indexOf("tag-name") && ("<" === o.value ? c[p]++ : "</" === o.value && c[p]--, 0 === c[p] && (l = !0))); while (o && !l)
                                    }
                                    r && r.type.indexOf("tag-name") && (f = g.start, f.row == i.row && Math.abs(f.column - i.column) < 2 && (f = g.end))
                                }
                        ...
                        null == t.needle && (e = this.session.getTextRange(o) || this.$search.$options.needle, e || (o = this.session.getWordRange(o.start.row, o.start.column), e = this.session.getTextRange(o)), this.$search.set({
                            needle: e
                ...
                }).call(w.prototype), m.defineOptions(w.prototype, "editor", {
                    selectionStyle: {
                        set: function(e) {
                    ...
                    n.implement(this, r), this.setSession = function(e) {
                        ...
                        if (this.$annotations.length) {
                            var t = e.data,
                                ...
                                o = i.end.row - n;
                            if (0 === o);
                            else if ("removeText" == t.action || "removeLines" == t.action) this.$annotations.splice(n, o + 1, null);
                            else {
                                var r = new Array(o + 1);
                        ...
                        for (var t = this.session, n = e.firstRow, o = Math.min(e.lastRow + e.gutterOffset, t.getLength() - 1), r = t.getNextFoldLine(n), s = r ? r.start.row : 1 / 0, a = this.$showFoldWidgets && t.foldWidgets, l = t.$breakpoints, c = t.$decorations, h = t.$firstLineNumber, u = 0, d = t.gutterRenderer || this.$renderer, g = null, f = -1, p = n;;) {
                            ...
                            if (w) {
                                ...
                                m += "start" == w && p == s && p < r.end.row ? " ace_closed" : " ace_open", g.foldWidget.className != m && (g.foldWidget.className = m);
                ...
                (function() {
                        ...
                        if (e) {
                            ...
                            for (var i in this.markers) {
                                ...
                                if (n.range) {
                                    ...
                                    if (!o.isEmpty())
                                        if (o = o.toScreenRange(this.session), n.renderer) {
                    ...
                    }, this.drawTextMarker = function(e, t, n, o, r) {
                        var s = t.start.row,
                            a = new i(s, t.start.column, s, this.session.getScreenLastRowColumn(s));
                        for (this.drawSingleLineMarker(e, a, n + " ace_start", o, 1, r), s = t.end.row, a = new i(s, 0, s, t.end.column), this.drawSingleLineMarker(e, a, n, o, 0, r), s = t.start.row + 1; s < t.end.row; s++) a.start.row = s, a.end.row = s, a.end.column = this.session.getScreenLastRowColumn(s), this.drawSingleLineMarker(e, a, n, o, 1, r)
                ...
                (function() {
                    i.implement(this, r), this.EOF_CHAR = "¶", this.EOL_CHAR_LF = "¬", this.EOL_CHAR_CRLF = "¤", this.EOL_CHAR = this.EOL_CHAR_LF, this.TAB_CHAR = "→", this.SPACE_CHAR = "·", this.$padding = 0, this.$updateEolChar = function() {
                        ...
                        this.tabSize = e;
                        for (var t = this.$tabStrings = [0], i = 1; e + 1 > i; i++) t.push(this.showInvisibles ? "<span class='ace_invisible ace_invisible_tab'>" + this.TAB_CHAR + o.stringRepeat(" ", i - 1) + "</span>" : o.stringRepeat(" ", i));
                        if (this.displayIndentGuides) {
                            ...
                            } else var a = o.stringRepeat(" ", this.tabSize),
                                l = a;
                        ...
                        for (var o = this.element.ownerDocument.createDocumentFragment(), r = t, s = this.session.getNextFoldLine(r), a = s ? s.start.row : 1 / 0;;) {
                            ...
                            var l = n.createElement("div"),
                                c = [];
                            if (this.$renderLine(c, r, !1, r == a ? s : !1), l.innerHTML = c.join(""), this.$useLineGroups()) l.className = "ace_line_group", o.appendChild(l), l.style.height = e.lineHeight * this.session.getRowLength(r) + "px";
                            else
                        ...
                        var r = this,
                            ...
                            a = function(e, i, n, s) {
                                if (i) return r.showInvisibles ? "<span class='ace_invisible ace_invisible_space'>" + o.stringRepeat(r.SPACE_CHAR, e.length) + "</span>" : o.stringRepeat(" ", e.length);
                                if ("&" == e) return "&#38;";
                                if ("<" == e) return "&#60;";
                                if ("	" == e) {
                                ...
                                if ("　" == e) {
                                    var l = r.showInvisibles ? "ace_cjk ace_invisible ace_invisible_space" : "ace_cjk",
                                        c = r.showInvisibles ? r.SPACE_CHAR : "";
                        ...
                        for (var o = 0, r = 0, s = i[0], a = 0, l = 0; l < t.length; l++) {
                            ...
                            if (o + h.length < s) a = this.$renderToken(e, a, c, h), o += h.length;
                            else {
                        ...
                        if (n || 0 == n || (n = this.session.getFoldLine(t)), n) var o = this.$getFoldLineTokens(t, n);
                        else var o = this.session.getTokens(t);
                        ...
                        function i(e, t, i) {
                            ...
                            if (r != t) {
                                ...
                                s.length > i - t && (s = s.substring(0, i - t)), o.push({
                                    type: e[n].type,
                                    value: s
                                }), r = t + s.length, n += 1
                            }
                        ...
                        return t.walk(function(e, t, s, a, l) {
                            null != e ? o.push({
                                type: "fold",
                                value: e
                            }) : (l && (r = n.getTokens(t)), r.length && i(r, a, s))
                ...
                var a = function(e, t) {
                    s.call(this, e), this.scrollTop = 0, t.$scrollbarWidth = this.width = n.scrollbarWidth(e.ownerDocument), this.inner.style.width = this.element.style.width = (this.width || 15) + 5 + "px"
                };
                i.inherits(a, s),
                    function() {
                ...
                (function() {
                    i.implement(this, s), this.$characterSize = {
                        ...
                        e.width = e.height = "auto", e.left = e.top = "-100px", e.visibility = "hidden", e.position = "fixed", e.whiteSpace = "pre", r.isIE < 8 ? e["font-family"] = "inherit" : e.font = "inherit", e.overflow = t ? "hidden" : "visible"
                    }, this.checkForSizeChanges = function() {
                ...
                var m = function(e, t) {
                    ...
                    this.canvas = f.element, this.$markerFront = new a(this.content), this.$cursorLayer = new c(this.content), this.$horizScroll = !1, this.$vScroll = !1, this.scrollBar = this.scrollBarV = new u(this.container, this), this.scrollBarH = new h(this.container, this), this.scrollBarV.addEventListener("scroll", function(e) {
                        ...
                        v: 0,
                        h: 0
                    }, this.$loop = new d(this.$renderChanges.bind(this), this.container.ownerDocument.defaultView), this.$loop.schedule(this.CHANGE_FULL), this.updateCharacterSize(), this.setPadding(4), o.resetOptions(this), o._emit("renderer", this)
                };
                (function() {
                    this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, i.implement(this, f), this.updateCharacterSize = function() {
                        ...
                        if (!(this.resizing > 2)) {
                            ...
                            n || (n = o.clientHeight || o.scrollHeight), i || (i = o.clientWidth || o.scrollWidth);
                            var r = this.$updateCachedSize(e, t, i, n);
                            if (!this.$size.scrollerHeight || !i && !n) return this.resizing = 0;
                            e && (this.$gutterLayer.$padding = null), e ? this.$renderChanges(r | this.$changes, !0) : this.$loop.schedule(r | this.$changes), this.resizing && (this.resizing = 0)
                        }
                        ...
                        return n && (e || r.height != n) && (r.height = n, o |= this.CHANGE_SIZE, r.scrollerHeight = r.height, this.$horizScroll && (r.scrollerHeight -= this.scrollBarH.getHeight()), this.scrollBarV.element.style.bottom = this.scrollBarH.getHeight() + "px", o |= this.CHANGE_SCROLL), i && (e || r.width != i) && (o |= this.CHANGE_SIZE, r.width = i, null == t && (t = this.$showGutter ? this.$gutter.offsetWidth : 0), this.gutterWidth = t, this.scrollBarH.element.style.left = this.scroller.style.left = t + "px", r.scrollerWidth = Math.max(0, i - t - this.scrollBarV.getWidth()), this.scrollBarH.element.style.right = this.scroller.style.right = this.scrollBarV.getWidth() + "px", this.scroller.style.bottom = this.scrollBarH.getHeight() + "px", (this.session && this.session.getUseWrapMode() && this.adjustWrapLimit() || e) && (o |= this.CHANGE_FULL)), r.$dirty = !i || !n, o && this._signal("resize", s), o
                        ...
                        if (this.$keepTextAreaAtCursor) {
                            ...
                            if (!(0 > t || t > e.height - n)) {
                                ...
                                if (this.$composition) {
                                    ...
                                    o *= this.session.$getStringScreenWidth(r)[0] + 2, n += 2
                                }
                                i -= this.scrollLeft, i > this.$size.scrollerWidth - o && (i = this.$size.scrollerWidth - o), i += this.gutterWidth, this.textarea.style.height = n + "px", this.textarea.style.width = o + "px", this.textarea.style.left = Math.min(i, this.$size.scrollerWidth - o) + "px", this.textarea.style.top = Math.min(t, this.$size.height - n) + "px"
                            }
                        }
                    }, this.getFirstVisibleRow = function() {
                        ...
                        o.top = 0 | e, o.bottom = 0 | t, o.right = 0 | n, o.left = 0 | i, o.v = o.top + o.bottom, o.h = o.left + o.right, o.top && this.scrollTop <= 0 && this.session && this.session.setScrollTop(-o.top), this.updateFull()
                        ...
                        var u = !i && (this.$vScrollBarAlwaysVisible || t.scrollerHeight - o + h < 0 || this.scrollTop),
                            d = this.$vScroll !== u;
                        d && (this.$vScroll = u, this.scrollBarV.setVisible(u));
                        var g, f, p = Math.ceil(s / this.lineHeight) - 1,
                            m = Math.max(0, Math.round((this.scrollTop - r) / this.lineHeight)),
                            v = m + p,
                            w = this.lineHeight;
                        m = e.screenToDocumentRow(m, 0);
                        var A = e.getFoldLine(m);
                        A && (m = A.start.row), g = e.documentToScreenRow(m, 0), f = e.getRowLength(m) * w, v = Math.min(e.screenToDocumentRow(v, 0), e.getLength() - 1), s = t.scrollerHeight + e.getRowLength(v) * w + f, r = this.scrollTop - g * w;
                        var C = 0;
                        return this.layerConfig.width != a && (C = this.CHANGE_H_SCROLL), (c || d) && (C = this.$updateCachedSize(!0, this.gutterWidth, t.width, t.height), this._signal("scrollbarVisibilityChanged"), d && (a = this.$getLongestLine())), this.layerConfig = {
                            width: a,
                            ...
                            maxHeight: o,
                            offset: r,
                            gutterOffset: Math.max(0, Math.ceil((r + t.height - t.scrollerHeight) / w)),
                        ...
                        for (i = 0; n > i; ++i) o.push(r(i / this.STEPS, e, t - e));
                        return o
                    }, this.scrollToLine = function(e, t, i, n) {
                        ...
                        if (this.$animatedScroll) {
                            ...
                            if (e != i) {
                                ...
                                this.$scrollAnimation = {
                                    ...
                                    r.length ? (n.session.setScrollTop(r.shift()), n.session.$scrollTop = i) : null != i ? (n.session.$scrollTop = -1, n.session.setScrollTop(i), i = null) : (n.$timer = clearInterval(n.$timer), n.$scrollAnimation = null, t && t())
                                }, 10)
                            }
                        }
                        ...
                        function i(i) {
                            ...
                            if (i.cssClass) {
                                n.importCssString(i.cssText, i.cssClass, r.container.ownerDocument), r.theme && n.removeCssClass(r.container, r.theme.cssClass);
                                var o = "padding" in i ? i.padding : "padding" in (r.theme || {}) ? 4 : r.$padding;
                                r.$padding && o != r.$padding && r.setPadding(o), r.$theme = i.cssClass, r.theme = i, n.addCssClass(r.container, i.cssClass), n.setCssClass(r.container, "ace_dark", i.isDark), r.$size && (r.$size.width = 0, r.$updateSizeAsync()), r._dispatchEvent("themeLoaded", {
                                    theme: i
                                }), t && t()
                            }
                        }
                ...
                var n = e("../lib/oop"),
                    ...
                    s = e("../config"),
                    a = function(t, n, o, r) {
                        if (this.$sendDeltaQueue = this.$sendDeltaQueue.bind(this), this.changeListener = this.changeListener.bind(this), this.onMessage = this.onMessage.bind(this), e.nameToUrl && !e.toUrl && (e.toUrl = e.nameToUrl), s.get("packaged") || !e.toUrl) r = r || s.moduleUrl(n.id, "worker");
                        else {
                        ...
                        try {
                            ...
                            if (!(g instanceof window.DOMException)) throw g;
                            var u = this.$workerBlob(r),
                                f = window.URL || window.webkitURL,
                                p = f.createObjectURL(u);
                            this.$worker = new Worker(p), f.revokeObjectURL(p)
                        }
                ...
                var l = function(e, t, i) {
                    ...
                    this.$worker = {}, this.$worker.terminate = function() {}, this.$worker.postMessage = function(e) {
                        l.messageBuffer.push(e), n && (o ? setTimeout(c) : c())
                ...
                (function() {
                    o.implement(this, n), this.setup = function() {
                        var e = this,
                            ...
                            n = this.session,
                            o = this.$pos;
                        this.selectionBefore = n.selection.toJSON(), n.selection.inMultiSelectMode && n.selection.toSingleRange(), this.pos = t.createAnchor(o.row, o.column), this.markerId = n.addMarker(new i(o.row, o.column, o.row, o.column + this.length), this.mainClass, null, !1), this.pos.on("change", function(t) {
                ...
                function n(e) {
                    var t = e.domEvent,
                        ...
                        l = e.getAccelKey(),
                        c = e.getButton();
                    if (a && r.isMac && (c = t.button), e.editor.inMultiSelectMode && 2 == c) return void e.editor.textInput.onContextMenu(e.domEvent);
                    ...
                    if (0 === c) {
                        var h, u = e.editor,
                            ...
                            C = u.session,
                            E = u.renderer.pixelToScreenCoordinates(v, w),
                            y = E;
                        if (u.$mouseHandler.$enableJumpToDef) a && n || l && n ? h = "add" : n && (h = "block");
                        else if (l && !n) {
                            if (h = "add", !g && s) return
                        } else n && (h = "block");
                        if (h && r.isMac && t.ctrlKey && u.$mouseHandler.cancelContextMenu(), "add" == h) {
                            ...
                            u.$blockScrolling++, u.inVirtualSelectionMode = !0, s && (b = null, F = d.ranges[0], u.removeSelectionMarker(F)), u.once("mouseup", function() {
                                var e = d.toOrientedRange();
                                b && e.isEmpty() && i(b.cursor, e.cursor) ? d.substractPoint(e.cursor) : (s ? d.substractPoint(F.cursor) : F && (u.removeSelectionMarker(F), d.addRange(F)), d.addRange(e)), u.$blockScrolling--, u.inVirtualSelectionMode = !1
                            })
                        } else if ("block" == h) {
                            ...
                            var x, S = [],
                                D = function() {
                                    ...
                                    i(y, e) && i(t, d.lead) || (y = e, u.selection.moveToPosition(t), u.renderer.scrollCursorIntoView(), u.removeSelectionMarkers(S), S = d.rectangularRangeBlock(y, E), u.$mouseHandler.$clickSelection && 1 == S.length && S[0].isEmpty() && (S[0] = u.$mouseHandler.$clickSelection.clone()), S.forEach(u.addSelectionMarker, u), u.updateSelectionMarkers())
                                };
                            g && !l ? d.toSingleRange() : !g && l && (x = d.toOrientedRange(), u.addSelectionMarker(x)), s ? E = C.documentToScreenPosition(d.lead) : d.moveToPosition(f), y = {
                                row: -1,
                                column: -1
                            };
                            var B = function() {
                                    clearInterval(k), u.removeSelectionMarkers(S), S.length || (S = [d.toOrientedRange()]), u.$blockScrolling++, x && (u.removeSelectionMarker(x), d.toSingleRange(x));
                                    for (var e = 0; e < S.length; e++) d.addRange(S[e]);
                                    u.inVirtualSelectionMode = !1, u.$mouseHandler.$clickSelection = null, u.$blockScrolling--
                                },
                                $ = D;
                            o.capture(u.container, A, B);
                    ...
                    function() {
                        this.ranges = null, this.rangeList = null, this.addRange = function(e, t) {
                            ...
                            if (this.rangeCount > 1) {
                                ...
                                for (var u = o + 1; r > u; u++) c.push(this.getLineRange(u, !0));
                            ...
                            if (c && o.reverse(), !i) {
                                for (var p = o.length - 1; o[p].isEmpty() && p > 0;) p--;
                                if (p > 0)
                                    for (var m = 0; o[m].isEmpty();) m++;
                                for (var v = p; v >= m; v--) o[v].isEmpty() && o.splice(v, 1)
                            }
                            return o
                        }
                    }.call(l.prototype);
                ...
                (function() {
                    this.updateSelectionMarkers = function() {
                        ...
                        if (this.inMultiSelectMode && !this.inVirtualSelectionMode) {
                            ...
                            var o = t == this.multiSelect.anchor ? i.cursor == i.start ? i.end : i.start : i.cursor;
                            n(o, t) || this.multiSelect.toSingleRange(this.multiSelect.toOrientedRange())
                        }
                    }, this.onPaste = function(e) {
                        if (!this.$readOnly) {
                            var t = {
                            ...
                            for (var o = n.length; o--;) {
                                var r = n[o];
                                r.isEmpty() || this.session.remove(r), this.session.insert(r.start, i[o])
                            }
                        }
                        ...
                        return n && r.rangeList.rangeAtPoint(n.start) && r.addRange(n, !0), this.$blockScrolling -= 1, o.length
                        ...
                        var o = this.session,
                            r = o.multiSelect,
                            s = r.toOrientedRange();
                        if (!s.isEmpty() || (s = o.getWordRange(s.start.row, s.start.column), s.cursor = -1 == e ? s.start : s.end, this.multiSelect.addRange(s), !n)) {
                        ...
                        if (i.length && o.length != i.length - 1) {
                            ...
                            i.forEach(function(t, i) {
                                var n = t.cursor,
                                    o = r - n.column,
                                    c = l[i] - s;
                                o > c ? e.insert(n, u.stringRepeat(" ", o - c)) : e.remove(new a(n.row, n.column, n.row, n.column - o + c)), t.start.column = t.end.column = r, t.start.row = t.end.row = n.row, t.cursor = t.end
                            ...
                            if (g) {
                                ...
                                do f = this.session.getLine(d); while (/[=:]/.test(f) && ++d < p);
                                do f = this.session.getLine(h); while (/[=:]/.test(f) && --h > 0);
                                0 > h && (h = 0), d >= p && (d = p - 1)
                            }
                            var m = this.session.doc.removeLines(h, d);
                            m = this.$reAlignText(m, g), this.session.doc.insert({
                                row: h,
                                column: 0
                            }, m.join("\n") + "\n"), g || (c.start.column = 0, c.end.column = m[m.length - 1].length), this.selection.setRange(c)
                        }
                ...
                (function() {
                    this.foldingStartMarker = null, this.foldingStopMarker = null, this.getFoldWidget = function(e, t, i) {
                        ...
                        if (a) {
                            ...
                            return null == l && (l = e.getFoldWidget(a.row)), "start" == l && a.row > s.row && (a.row--, a.column = e.getLine(a.row).length), i.fromPoints(s, a)
                        }
                        ...
                        return s ? (s.column++, r.column--, i.fromPoints(s, r)) : void 0
                    }
                }).call(n.prototype)
                    ...
                    this.getRowLength = function(e) {
                        ...
                        if (i && i.length) {
                            for (var o = 1 / 0, r = 0; r < i.length; r++) {
                                var s = i[r];
                                s._inDocument || (s._inDocument = !0, t.container.appendChild(s.el)), s.h = s.el.offsetHeight, s.fixedWidth || (s.w = s.el.offsetWidth, s.screenWidth = Math.ceil(s.w / n.characterWidth));
                        ...
                        if (n) {
                            for (var o = Math.min(this.firstRow, i.firstRow), r = Math.max(this.lastRow, i.lastRow, n.length); o > 0 && !n[o];) o--;
                ...
                function n(e, t, n) {
                    ...
                    if (o.length) {
                        ...
                        0 > r && (r = -r - 1), r >= o.length - 1 ? r = n > 0 ? 0 : o.length - 1 : 0 === r && 0 > n && (r = o.length - 1);
                        var a = o[r];
                        if (a && n) {
                            if (a.row === t) {
                                do a = o[r += n]; while (a && a.row === t);
                                if (!a) return o.slice()
                            }
                            var l = [];
                            t = a.row;
                            do l[0 > n ? "unshift" : "push"](a), a = o[r += n]; while (a && a.row == t);
                            return l.length && l
                        }
                    }
                }
                ...
                e("./worker/worker_client"), e("./keyboard/hash_handler"), e("./placeholder"), e("./multi_select"), e("./mode/folding/fold_mode"), e("./theme/textmate"), e("./ext/error_marker"), t.config = e("./config"), t.acequire = e, t.edit = function(e) {
                    if ("string" == typeof e) {
                        var r = e;
                        if (e = document.getElementById(r), !e) throw new Error("ace.edit can't find div #" + r)
                    }
                    ...
                    } else s = i.getInnerText(e), e.innerHTML = "";
                    ...
                    return l && (u.textarea = l), n.addListener(window, "resize", u.onResize), h.on("destroy", function() {
        ...
        ace.define("ace/mode/json_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(e, t) {
            "use strict";
            var i = e("../lib/oop"),
                n = e("./text_highlight_rules").TextHighlightRules,
                o = function() {
            ...
            i.inherits(o, n), t.JsonHighlightRules = o
            ...
            var i, n = e("../../lib/oop"),
                ...
                h = function(e) {
                    var t = -1;
                    return e.multiSelect && (t = e.selection.index, c.rangeCount != e.multiSelect.rangeCount && (c = {
                ...
                u = function() {
                    this.add("braces", "insertion", function(e, t, n, o, r) {
                        var a = n.getCursorPosition(),
                            l = o.doc.getLine(a.row);
                        if ("{" == r) {
                            h(n);
                            var c = n.getSelectionRange(),
                                d = o.doc.getTextRange(c);
                            if ("" !== d && "{" !== d && n.getWrapBehavioursEnabled()) return {
                                text: "{" + d + "}",
                                selection: !1
                            };
                            if (u.isSaneInsertion(n, o)) return /[\]\}\)]/.test(l[a.column]) || n.inMultiSelectMode ? (u.recordAutoInsert(n, o, "}"), {
                                text: "{}",
                                selection: [1, 1]
                            }) : (u.recordMaybeInsert(n, o, "{"), {
                                text: "{",
                                selection: [1, 1]
                            })
                        } else if ("}" == r) {
                            ...
                            if ("}" == g) {
                                var f = o.$findOpeningBracket("}", {
                                    column: a.column + 1,
                                    row: a.row
                                });
                                if (null !== f && u.isAutoInsertedClosing(a, l, r)) return u.popAutoInsertedClosing(), {
                                    text: "",
                                    selection: [1, 1]
                                }
                            }
                            ...
                            if ("\n" == r || "\r\n" == r) {
                                h(n);
                                var p = "";
                                u.isMaybeInsertedClosing(a, l) && (p = s.stringRepeat("}", i.maybeInsertedBrackets), u.clearMaybeInsertedClosing());
                                var g = l.substring(a.column, a.column + 1);
                                if ("}" === g) {
                                    ...
                                    if (!p) return void u.clearMaybeInsertedClosing();
                        ...
                        if ("(" == o) {
                            ...
                            if ("" !== s && i.getWrapBehavioursEnabled()) return {
                                text: "(" + s + ")",
                                selection: !1
                            };
                            if (u.isSaneInsertion(i, n)) return u.recordAutoInsert(i, n, ")"), {
                                text: "()",
                                selection: [1, 1]
                            }
                        } else if (")" == o) {
                            ...
                            if (")" == c) {
                                var d = n.$findOpeningBracket(")", {
                                    column: a.column + 1,
                                    row: a.row
                                });
                                if (null !== d && u.isAutoInsertedClosing(a, l, o)) return u.popAutoInsertedClosing(), {
                                    text: "",
                                    selection: [1, 1]
                                }
                            }
                        ...
                        if ('"' == o || "'" == o) {
                            ...
                            if ("" !== a && "'" !== a && '"' != a && i.getWrapBehavioursEnabled()) return {
                                text: r + a + r,
                                selection: !1
                            };
                            ...
                            if ("\\" == d) return null;
                            for (var g, f = n.getTokens(s.start.row), p = 0, m = -1, v = 0; v < f.length && (g = f[v], "string" == g.type ? m = -1 : 0 > m && (m = g.value.indexOf(r)), !(g.value.length + p > s.start.column)); v++) p += f[v].value.length;
                            if (!g || 0 > m && "comment" !== g.type && ("string" !== g.type || s.start.column !== g.value.length + p - 1 && g.value.lastIndexOf(r) === g.value.length - 1)) {
                                if (!u.isSaneInsertion(i, n)) return;
                                return {
                                    text: r + r,
                                    selection: [1, 1]
                                }
                            ...
                            if (g && "string" === g.type) {
                                var w = c.substring(l.column, l.column + 1);
                                if (w == r) return {
                                    text: "",
                                    selection: [1, 1]
                                }
            ...
            u.isSaneInsertion = function(e, t) {
                ...
                if (!this.$matchTokenType(n.getCurrentToken() || "text", a)) {
                    var o = new r(t, i.row, i.column + 1);
                    if (!this.$matchTokenType(o.getCurrentToken() || "text", a)) return !1
                }
            ...
            }, n.inherits(u, o), t.CstyleBehaviour = u
            ...
            i.inherits(r, o),
                function() {
                    this.foldingStartMarker = /(\{|\[)[^\}\]]*$|^\s*(\/\*)/, this.foldingStopMarker = /^[^\[\{]*(\}|\])|^[\s\*]*(\*\/)/, this.getFoldWidgetRange = function(e, t, i, n) {
                        var o = e.getLine(i),
                            r = o.match(this.foldingStartMarker);
                        if (r) {
                            var s = r.index;
        ...
        }), ace.define("ace/mode/json", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/json_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle", "ace/worker/worker_client"], function(e, t) {
            "use strict";
            var n = e("../lib/oop"),
                o = e("./text").Mode,
                ...
                h = function() {
                    this.HighlightRules = r, this.$outdent = new s, this.$behaviour = new a, this.foldingRules = new l
                };
            n.inherits(h, o),
                function() {
                    this.getNextLineIndent = function(e, t, i) {
                        ...
                        var t = new c(["ace"], i(16), "JsonWorker");
        ...
        function n(e, t) {
            function i(e, t, o) {
                o.forEach(function(o) {
                    if ("separator" == o.type) {
                        ...
                        r.className = "separator", a = document.createElement("li"), a.appendChild(r), e.appendChild(a)
                    } else {
                        var s = {},
                            a = document.createElement("li");
                        e.appendChild(a);
                        var l = document.createElement("button");
                        if (l.className = o.className, s.button = l, o.title && (l.title = o.title), o.click && (l.onclick = function() {
                                n.hide(), o.click()
                            }), a.appendChild(l), o.submenu) {
                            var c = document.createElement("div");
                            c.className = "icon", l.appendChild(c), l.appendChild(document.createTextNode(o.text));
                            var h;
                            if (o.click) {
                                l.className += " default";
                                var u = document.createElement("button");
                                s.buttonExpand = u, u.className = "expand", u.innerHTML = '<div class="expand"></div>', a.appendChild(u), o.submenuTitle && (u.title = o.submenuTitle), h = u
                            } else {
                                var d = document.createElement("div");
                                d.className = "expand", l.appendChild(d), h = l
                            }
                            h.onclick = function() {
                                n._onExpandItem(s), h.focus()
                            };
                            var g = [];
                            s.subItems = g;
                            var f = document.createElement("ul");
                            s.ul = f, f.className = "menu", f.style.height = "0", a.appendChild(f), i(f, g, o.submenu)
                        } else l.innerHTML = '<div class="icon"></div>' + o.text;
                        t.push(s)
                    }
                })
            }
            ...
            var r = document.createElement("div");
            r.className = "jsoneditor-contextmenu", o.menu = r;
            var s = document.createElement("ul");
            s.className = "menu", r.appendChild(s), o.list = s, o.items = [];
            var a = document.createElement("button");
            o.focusButton = a;
            var l = document.createElement("li");
            l.style.overflow = "hidden", l.style.height = "0", l.appendChild(a), s.appendChild(l), i(s, this.dom.items, e), this.maxHeight = 0, e.forEach(function(t) {
        ...
        n.prototype._getVisibleButtons = function() {
        ...
        }, n.visibleMenu = void 0, n.prototype.show = function(e) {
            this.hide();
            var t = window.innerHeight,
                i = window.pageYOffset || document.scrollTop || 0,
                r = t + i,
                s = e.offsetHeight,
                a = this.maxHeight,
                l = o.getAbsoluteLeft(e),
                c = o.getAbsoluteTop(e);
            r > c + s + a ? (this.dom.menu.style.left = l + "px", this.dom.menu.style.top = c + s + "px", this.dom.menu.style.bottom = "") : (this.dom.menu.style.left = l + "px", this.dom.menu.style.top = "", this.dom.menu.style.bottom = t - c + "px"), document.body.appendChild(this.dom.menu);
            var h = this,
                u = this.dom.list;
            this.eventListeners.mousedown = o.addEventListener(document, "mousedown", function(e) {
                var t = e.target;
                t == u || h._isChildOf(t, u) || (h.hide(), e.stopPropagation(), e.preventDefault())
            }), this.eventListeners.mousewheel = o.addEventListener(document, "mousewheel", function(e) {
                e.stopPropagation(), e.preventDefault()
            }), this.eventListeners.keydown = o.addEventListener(document, "keydown", function(e) {
                h._onKeyDown(e)
            ...
            for (var e in this.eventListeners)
                if (this.eventListeners.hasOwnProperty(e)) {
                    ...
                    t && o.removeEventListener(document, e, t), delete this.eventListeners[e]
                }
            ...
            if (n && (n.ul.style.height = "0", n.ul.style.padding = "", setTimeout(function() {
                    t.expandedItem != n && (n.ul.style.display = "", o.removeClassName(n.ul.parentNode, "selected"))
                ...
                }, 0), o.addClassName(r.parentNode, "selected"), this.expandedItem = e
            }
        }, n.prototype._onKeyDown = function(e) {
            var t, i, n, r, s = e.target,
                a = e.which,
                l = !1;
            27 == a ? (this.selection && o.setSelection(this.selection), this.anchor && this.anchor.focus(), this.hide(), l = !0) : 9 == a ? e.shiftKey ? (t = this._getVisibleButtons(), i = t.indexOf(s), 0 == i && (t[t.length - 1].focus(), l = !0)) : (t = this._getVisibleButtons(), i = t.indexOf(s), i == t.length - 1 && (t[0].focus(), l = !0)) : 37 == a ? ("expand" == s.className && (t = this._getVisibleButtons(), i = t.indexOf(s), n = t[i - 1], n && n.focus()), l = !0) : 38 == a ? (t = this._getVisibleButtons(), i = t.indexOf(s), n = t[i - 1], n && "expand" == n.className && (n = t[i - 2]), n || (n = t[t.length - 1]), n && n.focus(), l = !0) : 39 == a ? (t = this._getVisibleButtons(), i = t.indexOf(s), r = t[i + 1], r && "expand" == r.className && r.focus(), l = !0) : 40 == a && (t = this._getVisibleButtons(), i = t.indexOf(s), r = t[i + 1], r && "expand" == r.className && (r = t[i + 2]), r || (r = t[0]), r && (r.focus(), l = !0), l = !0), l && (e.stopPropagation(), e.preventDefault())
        ...
        function n(e) {
            ...
            return t.prototype = new e, t.prototype.getDom = function() {
                ...
                return r.innerHTML = "(empty)", r.className = "readonly", o.appendChild(r), e.td = o, e.text = r, this.updateDom(), t
                ...
                var t = e.type,
                    ...
                    n = this.dom,
                    r = n.menu;
                if (i == r && ("mouseover" == t ? this.editor.highlighter.highlight(this.parent) : "mouseout" == t && this.editor.highlighter.unhighlight()), "click" == t && i == n.menu) {
        ...
        (function(e, n) {
            var o = function() {
                var e = {
                        ...
                        performAction: function(e, t, i, n, o, r) {
                            var s = r.length - 1;
                            switch (o) {
                                case 1:
                                ...
                                case 15:
                                    ...
                                    break;
                                case 16:
                                    this.$ = {}, this.$[r[s][0]] = r[s][1];
                                    break;
                                case 17:
                                    this.$ = r[s - 2], r[s - 2][r[s][0]] = r[s][1];
                                    break;
                                case 18:
                                    this.$ = [];
                                    break;
                        ...
                        parse: function(e) {
                            ...
                            for (var p, m, v, w, A, C, E, y, F, b = {};;) {
                                if (v = o[o.length - 1], this.defaultActions[v] ? w = this.defaultActions[v] : (null == p && (p = i()), w = a[v] && a[v][p]), "undefined" == typeof w || !w.length || !w[0]) {
                                    if (!u) {
                                        F = [];
                                        for (C in a[v]) this.terminals_[C] && C > 2 && F.push("'" + this.terminals_[C] + "'");
                                        var x = "";
                                        x = this.lexer.showPosition ? "Parse error on line " + (c + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + F.join(", ") + ", got '" + this.terminals_[p] + "'" : "Parse error on line " + (c + 1) + ": Unexpected " + (1 == p ? "end of input" : "'" + (this.terminals_[p] || p) + "'"), this.parseError(x, {
                                    ...
                                    m = p, p = d, v = o[o.length - 1], w = a[v] && a[v][d], u = 3
                                }
                                if (w[0] instanceof Array && w.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + v + ", token: " + p);
                                switch (w[0]) {
                                    case 1:
                                        o.push(p), r.push(this.lexer.yytext), s.push(this.lexer.yylloc), o.push(w[1]), p = null, m ? (p = m, m = null) : (h = this.lexer.yyleng, l = this.lexer.yytext, c = this.lexer.yylineno, f = this.lexer.yylloc, u > 0 && u--);
                                        break;
                                    case 2:
                                        if (E = this.productions_[w[1]][1], b.$ = r[r.length - E], b._$ = {
                                                first_line: s[s.length - (E || 1)].first_line,
                                                last_line: s[s.length - 1].last_line,
                                                first_column: s[s.length - (E || 1)].first_column,
                                                last_column: s[s.length - 1].last_column
                                            }, A = this.performAction.call(b, l, h, c, this.yy, w[1], r, s), "undefined" != typeof A) return A;
                                        E && (o = o.slice(0, -1 * E * 2), r = r.slice(0, -1 * E), s = s.slice(0, -1 * E)), o.push(this.productions_[w[1]][0]), r.push(b.$), s.push(b._$), y = a[o[o.length - 2]][o[o.length - 1]], o.push(y);
                                        break;
                                    case 3:
                                        return !0
                                }
            ...
            t.parser = o, t.parse = function() {
                ...
                if ("undefined" != typeof e) var o = i(! function() {
                    var e = new Error('Cannot find module "fs"');
                    throw e.code = "MODULE_NOT_FOUND", e
                }()).readFileSync(i(20).join(e.cwd(), n[1]), "utf8");
                else var r = i(! function() {
            ...
            }, "undefined" != typeof n && i.c[0] === n && t.main("undefined" != typeof e ? e.argv.slice(1) : i(! function() {
                var e = new Error('Cannot find module "system"');
                throw e.code = "MODULE_NOT_FOUND", e
            }()).args)
        }).call(t, i(19), i(18)(e))
    }, function(e) {
        ...
        }(), i.title = "browser", i.browser = !0, i.env = {}, i.argv = [], i.on = t, i.addListener = t, i.once = t, i.off = t, i.removeListener = t, i.removeAllListeners = t, i.emit = t, i.binding = function() {
        ...
        (function(e) {
            ...
            t.resolve = function() {
                ...
                return e = i(n(e.split("/"), function(e) {
                    return !!e
                }), !o).join("/"), e || o || (e = "."), e && r && (e += "/"), (o ? "/" : "") + e
            }, t.isAbsolute = function(e) {
                return "/" === e.charAt(0)
            }, t.join = function() {
                var e = Array.prototype.slice.call(arguments, 0);
                return t.normalize(n(e, function(e) {
                ...
                for (var o = n(e.split("/")), r = n(i.split("/")), s = Math.min(o.length, r.length), a = s, l = 0; s > l; l++)
                    if (o[l] !== r[l]) {
                        a = l;
                        break
                    }
                for (var c = [], l = a; l < o.length; l++) c.push("..");
            ...
            function i() {
                ...
                return function(e, t) {
                    var n = new i,
                        ...
                        r = t.type;
                    if (o)
                        for (var s = 0, a = e.length; a > s; ++s) n.append(e[s], o);
                    else
                        for (var s = 0, a = e.length; a > s; ++s) n.append(e[s]);
...
util.addEventListener = function(e, t, i, n) {
    ...
    var t = function() {
            f.parentNode && f.parentNode.removeChild(f), o.parentNode && o.parentNode.removeChild(o), util.removeEventListener(document, "keydown", n)
        },
        i = function() {
    ...
    r.className = "prompt-form", r.target = e.formTarget || "", r.action = e.formAction || "", r.method = e.formMethod || "POST", r.enctype = "multipart/form-data", r.encoding = "multipart/form-data", r.onsubmit = function() {
    ...
    if (s.className = "prompt-title", s.appendChild(document.createTextNode(e.title || "Dialog")), r.appendChild(s), e.description) {
        var a = document.createElement("div");
        a.className = "prompt-description", a.innerHTML = e.description, r.appendChild(a)
    }
    var l = document.createElement("input");
    l.className = "prompt-field", l.type = e.inputType || "text", l.name = e.inputName || "text", l.value = e.inputDefault || "";
    var c = document.createElement("div");
    c.className = "prompt-contents", c.appendChild(l), r.appendChild(c);
    var h = document.createElement("input");
    h.className = "prompt-cancel", h.type = "button", h.value = e.titleCancel || "Cancel", h.onclick = i;
    var u = document.createElement("input");
    u.className = "prompt-submit", u.type = "submit", u.value = e.titleSubmit || "Ok";
    var d = document.createElement("div");
    d.className = "prompt-buttons", d.appendChild(h), d.appendChild(u), r.appendChild(d);
    var g = document.createElement("div");
    g.className = "prompt-border", g.appendChild(r);
    var f = document.createElement("div");
    f.className = "prompt-background", f.appendChild(g), f.onclick = function(e) {
        var t = e.target;
        t == f && i()
    }, document.body.appendChild(f), l.focus(), l.select()
    ...
    for (var e, t, i = window.location.search.substring(1), n = i.split("&"), o = {}, r = 0, s = n.length; s > r; r++) {
        var a = n[r].split("=");
        2 == a.length ? (e = decodeURIComponent(a[0]), t = decodeURIComponent(a[1])) : (e = decodeURIComponent(a), t = ""), o[e] = t
    }
    return o
...
Notify.prototype.showNotification = function(e, t) {
    ...
    if (!t) {
        ...
        t = document.createElement("div"), t.style.position = "absolute", t.style.left = (o - i) / 2 + "px", t.style.width = i + "px", t.style.top = n + "px", t.style.zIndex = "999", document.body.appendChild(t), this.dom.frame = t
    }
    var r = e.type || "notification",
        s = e.closeButton !== !1,
        a = document.createElement("div");
    a.className = r, a.type = r, a.closeable = s, a.style.position = "relative", t.appendChild(a);
    ...
    if (u.innerHTML = e.message || "", h.appendChild(u), s) {
        var d = document.createElement("td");
        d.style.textAlign = "right", d.style.verticalAlign = "top", h.appendChild(d);
        var g = document.createElement("button");
        g.innerHTML = "&times;", g.title = "Close message (ESC)", d.appendChild(g);
        var f = this;
        g.onclick = function() {
            f.removeMessage(a)
        }
    ...
    var n = this,
        o = function(e, o) {
            t && (t(e, o), t = void 0), n.notify && i && (n.notify.removeMessage(i), i = void 0)
        },
        r = this.scriptUrl;
    ajax.get(e, n.headers, function(t, i, s) {
        if (200 == s) o(null, i);
            ...
            ajax.get(a, n.headers, function(t, i, n) {
                200 == n ? o(null, i) : 404 == n ? (console.log('Error: url "' + e + '" not found', n, i), t = new Error('Error: url "' + e + '" not found'), o(t, null)) : (console.log('Error: failed to load url "' + e + '"', n, i), t = new Error('Error: failed to load url "' + e + '"'), o(t, null))
            })
        }
    }), setTimeout(function() {
    ...
    var t = void 0,
        ...
        o = function(n, o, r) {
            e && (e(n, o, r), e = null), i.notify && t && (i.notify.removeMessage(t), t = void 0)
        },
    ...
    var r = this,
        s = function(e) {
            i && (i(e), i = void 0), r.notify && o && (r.notify.removeMessage(o), o = void 0)
        },
        a = document.createElement("a");
    this.options.html5 && void 0 != a.download && !util.isFirefox() ? (a.style.display = "none", a.href = "data:application/json;charset=utf-8," + encodeURIComponent(e), a.download = n, document.body.appendChild(a), a.click(), document.body.removeChild(a), s()) : e.length < this.options.maxSize ? ajax.post(r.scriptUrl, e, r.headers, function(e, t, i) {
        if (200 == i) {
            var o = document.createElement("iframe");
            o.src = r.scriptUrl + "?id=" + t + "&filename=" + n, r._hide(o), document.body.appendChild(o), s()
    ...
    this.queue.push({
        ...
        options: t,
        callback: i
    }), this.revs[e._id] = e._rev, this.saving || this._save()
    ...
    if (e) {
        ...
        var o, r = this,
            s = t.name || null,
            a = i && i.silent || !1;
        t.name = s, t._rev = this.revs[t._id] || t._rev, a || (o = this.notify.showNotification("saving document..."));
        var l = JSON.stringify(t),
            c = {
                "content-type": "application/json"
            };
        ajax.put(this.url, l, c, function(e, i, a) {
            if (r.notify.removeMessage(o), 200 == a) {
                var l = JSON.parse(i),
                    c = l && l.id || t._id || null,
    ...
    ajax.get(this.url + e, null, function(e, o, r) {
        i.removeMessage(n), 200 == r ? t(null, JSON.parse(o)) : t(OnlineStore._createError(e || o, new Error("Failed to load document")), null)
    })
    ...
    ajax.del(this.url + e._id + "/" + e._rev, null, function(e, o, r) {
        i.removeMessage(n), 200 == r || 404 == r ? t(null, o) : t(OnlineStore._createError(e || o, new Error("Failed to delete document")), null)
    })
...
app.doc = {
    ...
    try {
        ...
        }), e = document.getElementById("treeEditor"), treeEditor = new JSONEditor(e, {
            mode: "tree",
            change: function() {
        ...
        }, util.addEventListener(window, "resize", app.resize), codeEditor.editor.commands.removeCommand("showSettingsMenu"), document.body.onkeydown = function(e) {
        ...
        o.href = document.location.pathname + "#new", o.onclick = function() {
        ...
        l.onclick = app.saveOnline, window.onblur = app._saveOnlineIfChanged, document.getElementById("menu").onmouseover = app._saveOnlineIfChanged, window.onfocus = function() {
            app.showFilesList()
        }, codeEditor.focus(), document.body.spellcheck = !1, app.showFilesList();
        var c, h = new QueryParams,
            u = h.getValue("json"),
            d = h.getValue("url"),
            g = h.getValue("id"),
            f = "#new" == location.hash,
            p = "#open" == location.hash;
        if (g) app.openOnline(g);
        else if (u) codeEditor.setText(u), treeEditor.setText(u), app.changed = !1;
        else if (d) app.openUrl(d);
        else if (f) location.hash = "", codeEditor.setText(""), app.changed = !1;
        else if (p) location.hash = "", app.openFromDisk();
        // else if (void 0 !== (c = localStorage.data)) codeEditor.setText(c), treeEditor.setText(c), app.changed = !1;
        else {
            var m = {
                array: [1, 2, 3],
                "boolean": !0,
            ...
            codeEditor.set(m), treeEditor.set(m)
        }
        newFeatureInfo()
    } catch (v) {
        try {
            ...
            console && console.log && console.log(v), alert(v)
        }
    }
    ...
    function t(t, i) {
        console.log("url", e), t ? app.notify.showError(t) : i && (app.setData(i), app.setMetaData({
            name: util.getName(e)
        }))
    }
    ...
    }, localStorage.files = JSON.stringify(i), app.showFilesList(i)
    ...
    //         r.className = "open", r.href = location.pathname + "?id=" + t, r.appendChild(document.createTextNode(n.name || t)), r.title = "Date: " + n.updated.substring(0, 19).replace("T", " "), o.appendChild(r);
    ...
    app.showStatus("saving changes..."), app.store.save(t, i, function(t, i) {
        if (t) "Error: Document update conflict." == t.toString() && (t = new Error('Document update conflict.<p>This document has been changed in an other browser or tab.</p><p>Solutions:</p><ul><li><a href="javascript: location.reload();">load latest version from the server</a> (overrides your local changes)</li><li><a href="javascript: app._forceSaveOnline();">save my version to the server</a> (overrides the changes on the server)</li></ul>')), app.conflictMessages.push(app.notify.showError(t)), app.showStatus("failed to save");
            ...
            app.saveLocal(i), app.setMetaData(i), app.showStatus("saved"), e || app.notify.showNotification('file has been saved as "' + app.doc.name + '"', 1e3);
    ...
    app.store.remove(e, function(t) {
        if (t) app.notify.showError(t);
        else {
            var i = localStorage.files,
                n = i ? JSON.parse(i) : {};
            delete n[e._id], localStorage.files = JSON.stringify(n), app.doc._id == e._id ? (app.changed = !1, document.location.href = document.location.pathname + "#new") : app.showFilesList(n)
        }
    })
    ...
    return "undefined" != typeof jsonlint && (i += '<a class="error" href="http://zaach.github.com/jsonlint/" target="_blank">validated by jsonlint</a>'), i
    ...
    if (c && (l -= c + a), app.splitter) {
        ...
        var h = app.splitter.getValue(),
            ...
            d = 1 > h,
            g = u && d;
        o.style.display = g ? "" : "none";
        var f, p = n.clientWidth;
        if (u)
            if (d) {
                f = l * h - p / 2;
                var m = 8 == util.getInternetExplorerVersion();
                r.innerHTML = m ? "|" : "&#8942;", r.title = "Drag left or right to change the width of the panels"
            } else f = l * h - p, r.innerHTML = "&lsaquo;", r.title = "Drag left to show the tree editor";
        else f = 0, r.innerHTML = "&rsaquo;", r.title = "Drag right to show the code editor";
        i.style.display = 0 == h ? "none" : "", i.style.width = Math.max(Math.round(f), 0) + "px", codeEditor.resize(), r.style.height = n.clientHeight - o.clientHeight - 2 * a - (g ? a : 0) + "px", r.style.lineHeight = r.style.height, t.style.display = 1 == h ? "none" : "", t.style.left = Math.round(f + p) + "px", t.style.width = Math.max(Math.round(l - f - p - 2), 0) + "px"
    }
    e && (e.style.right = c ? a + (c + a) + "px" : a + "px")
};